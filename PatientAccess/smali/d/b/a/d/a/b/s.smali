.class public final Ld/b/a/d/a/b/s;
...
.method public static e(Ld/b/a/d/a/b/v;Ljava/io/InputStream;Ljava/io/OutputStream;J)V
    .locals 13
    ...
    new-instance v0, Ld/b/a/d/a/b/u;
    ...
    :goto_0
    invoke-direct {v0, v1}, Ld/b/a/d/a/b/u;-><init>(Ljava/lang/String;)V
    ...
    :try_start_1
    invoke-static/range {v1 .. v6}, Ld/b/a/d/a/b/s;->f([BLjava/io/DataInputStream;Ljava/io/OutputStream;IJ)V
    ...
    invoke-static/range {v1 .. v8}, Ld/b/a/d/a/b/s;->g([BLd/b/a/d/a/b/v;Ljava/io/OutputStream;JIJ)V
...
.method private static g([BLd/b/a/d/a/b/v;Ljava/io/OutputStream;JIJ)V
    .locals 7
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    :try_start_0
    new-instance p6, Ld/b/a/d/a/b/w;
    ...
    invoke-direct/range {v1 .. v6}, Ld/b/a/d/a/b/w;-><init>(Ld/b/a/d/a/b/v;JJ)V

    invoke-virtual {p6}, Ld/b/a/d/a/b/v;->f()Ljava/io/InputStream;
    ...
    :try_start_3
    invoke-static {p0, p1}, Ld/b/a/d/a/b/d0;->a(Ljava/lang/Throwable;Ljava/lang/Throwable;)V
