...
.field private R3:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List<",
            "Ld/b/d/b;",
...
.method public constructor <init>()V
    ...
    .line 3
    iput v0, p0, Lcom/google/gson/internal/Excluder;->q:I

    const/4 v0, 0x1

    .line 4
    iput-boolean v0, p0, Lcom/google/gson/internal/Excluder;->x:Z
    ...
    iput-object v0, p0, Lcom/google/gson/internal/Excluder;->Q3:Ljava/util/List;
    ...
    iput-object v0, p0, Lcom/google/gson/internal/Excluder;->R3:Ljava/util/List;
...
.method private e(Ljava/lang/Class;)Z
    ...
    const-class v0, Ld/b/d/x/d;

    invoke-virtual {p1, v0}, Ljava/lang/Class;->getAnnotation(Ljava/lang/Class;)Ljava/lang/annotation/Annotation;

    move-result-object v0

    check-cast v0, Ld/b/d/x/d;

    const-class v2, Ld/b/d/x/e;

    invoke-virtual {p1, v2}, Ljava/lang/Class;->getAnnotation(Ljava/lang/Class;)Ljava/lang/annotation/Annotation;

    move-result-object v2

    check-cast v2, Ld/b/d/x/e;

    invoke-direct {p0, v0, v2}, Lcom/google/gson/internal/Excluder;->n(Ld/b/d/x/d;Ld/b/d/x/e;)Z
    ...
    .line 2
    :cond_0
    iget-boolean v0, p0, Lcom/google/gson/internal/Excluder;->x:Z
...
.method private g(Ljava/lang/Class;Z)Z
    ...
    .line 1
    iget-object p2, p0, Lcom/google/gson/internal/Excluder;->Q3:Ljava/util/List;

    goto :goto_0

    :cond_0
    iget-object p2, p0, Lcom/google/gson/internal/Excluder;->R3:Ljava/util/List;
    ...
    .line 3
    invoke-interface {v0, p1}, Ld/b/d/b;->b(Ljava/lang/Class;)Z
...
.method private l(Ld/b/d/x/d;)Z
    .locals 4

    if-eqz p1, :cond_0

    .line 1
    invoke-interface {p1}, Ld/b/d/x/d;->value()D
...
.method private m(Ld/b/d/x/e;)Z
    .locals 4

    if-eqz p1, :cond_0

    .line 1
    invoke-interface {p1}, Ld/b/d/x/e;->value()D
...
.method private n(Ld/b/d/x/d;Ld/b/d/x/e;)Z
    .locals 0

    .line 1
    invoke-direct {p0, p1}, Lcom/google/gson/internal/Excluder;->l(Ld/b/d/x/d;)Z

    move-result p1

    if-eqz p1, :cond_0

    invoke-direct {p0, p2}, Lcom/google/gson/internal/Excluder;->m(Ld/b/d/x/e;)Z
...
.method public b(Ld/b/d/f;Ld/b/d/y/a;)Ld/b/d/v;
    ...
    invoke-direct/range {v5 .. v10}, Lcom/google/gson/internal/Excluder$a;-><init>(Lcom/google/gson/internal/Excluder;ZZLd/b/d/f;Ld/b/d/y/a;)V
...
.method public h(Ljava/lang/reflect/Field;Z)Z
    ...
    .line 1
    iget v0, p0, Lcom/google/gson/internal/Excluder;->q:I
    ...
    .line 6
    const-class v0, Ld/b/d/x/a;

    invoke-virtual {p1, v0}, Ljava/lang/reflect/Field;->getAnnotation(Ljava/lang/Class;)Ljava/lang/annotation/Annotation;

    move-result-object v0

    check-cast v0, Ld/b/d/x/a;
    ...
    .line 7
    invoke-interface {v0}, Ld/b/d/x/a;->serialize()Z
    ...
    :cond_3
    invoke-interface {v0}, Ld/b/d/x/a;->deserialize()Z
    ...
    invoke-direct {v0, p1}, Ld/b/d/c;-><init>(Ljava/lang/reflect/Field;)V
    ...
    .line 14
    invoke-interface {p2, v0}, Ld/b/d/b;->a(Ld/b/d/c;)Z
