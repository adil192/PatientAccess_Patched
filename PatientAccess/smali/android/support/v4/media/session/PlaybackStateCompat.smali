...
.field final R3:Ljava/lang/CharSequence;
...
.field final V3:Landroid/os/Bundle;

.field private W3:Ljava/lang/Object;
...
.method constructor <init>(IJJFJILjava/lang/CharSequence;JLjava/util/List;JLandroid/os/Bundle;)V
    ...
    .line 7
    iput v1, v0, Landroid/support/v4/media/session/PlaybackStateCompat;->Q3:I

    move-object v1, p10

    .line 8
    iput-object v1, v0, Landroid/support/v4/media/session/PlaybackStateCompat;->R3:Ljava/lang/CharSequence;

    move-wide v1, p11

    .line 9
    iput-wide v1, v0, Landroid/support/v4/media/session/PlaybackStateCompat;->S3:J
    ...
    iput-object v1, v0, Landroid/support/v4/media/session/PlaybackStateCompat;->T3:Ljava/util/List;

    move-wide/from16 v1, p14

    .line 11
    iput-wide v1, v0, Landroid/support/v4/media/session/PlaybackStateCompat;->U3:J

    move-object/from16 v1, p16

    .line 12
    iput-object v1, v0, Landroid/support/v4/media/session/PlaybackStateCompat;->V3:Landroid/os/Bundle;
...
.method constructor <init>(Landroid/os/Parcel;)V
    ...
    iput-wide v0, p0, Landroid/support/v4/media/session/PlaybackStateCompat;->S3:J
    ...
    iput-object v0, p0, Landroid/support/v4/media/session/PlaybackStateCompat;->R3:Ljava/lang/CharSequence;
    ...
    iput-object v0, p0, Landroid/support/v4/media/session/PlaybackStateCompat;->T3:Ljava/util/List;
    ...
    iput-wide v0, p0, Landroid/support/v4/media/session/PlaybackStateCompat;->U3:J
    ...
    iput-object v0, p0, Landroid/support/v4/media/session/PlaybackStateCompat;->V3:Landroid/os/Bundle;
    ...
    iput p1, p0, Landroid/support/v4/media/session/PlaybackStateCompat;->Q3:I
...
.method public static a(Ljava/lang/Object;)Landroid/support/v4/media/session/PlaybackStateCompat;
    ...
    .line 17
    iput-object v0, v1, Landroid/support/v4/media/session/PlaybackStateCompat;->W3:Ljava/lang/Object;
...
.method public toString()Ljava/lang/String;
    ...
    iget-wide v1, p0, Landroid/support/v4/media/session/PlaybackStateCompat;->S3:J
    ...
    iget v1, p0, Landroid/support/v4/media/session/PlaybackStateCompat;->Q3:I
    ...
    iget-object v1, p0, Landroid/support/v4/media/session/PlaybackStateCompat;->R3:Ljava/lang/CharSequence;
    ...
    iget-object v1, p0, Landroid/support/v4/media/session/PlaybackStateCompat;->T3:Ljava/util/List;
    ...
    iget-wide v1, p0, Landroid/support/v4/media/session/PlaybackStateCompat;->U3:J
...
.method public writeToParcel(Landroid/os/Parcel;I)V
    ...
    .line 4
    iget-wide v0, p0, Landroid/support/v4/media/session/PlaybackStateCompat;->S3:J
    ...
    .line 7
    iget-object v0, p0, Landroid/support/v4/media/session/PlaybackStateCompat;->R3:Ljava/lang/CharSequence;

    invoke-static {v0, p1, p2}, Landroid/text/TextUtils;->writeToParcel(Ljava/lang/CharSequence;Landroid/os/Parcel;I)V

    .line 8
    iget-object p2, p0, Landroid/support/v4/media/session/PlaybackStateCompat;->T3:Ljava/util/List;

    invoke-virtual {p1, p2}, Landroid/os/Parcel;->writeTypedList(Ljava/util/List;)V

    .line 9
    iget-wide v0, p0, Landroid/support/v4/media/session/PlaybackStateCompat;->U3:J

    invoke-virtual {p1, v0, v1}, Landroid/os/Parcel;->writeLong(J)V

    .line 10
    iget-object p2, p0, Landroid/support/v4/media/session/PlaybackStateCompat;->V3:Landroid/os/Bundle;

    invoke-virtual {p1, p2}, Landroid/os/Parcel;->writeBundle(Landroid/os/Bundle;)V

    .line 11
    iget p2, p0, Landroid/support/v4/media/session/PlaybackStateCompat;->Q3:I
