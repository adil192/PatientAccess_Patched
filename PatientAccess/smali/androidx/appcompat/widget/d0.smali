...
.field private static b:Landroidx/appcompat/widget/d0;

.field private static final c:Landroidx/appcompat/widget/d0$c;
...
.field private j:Landroidx/appcompat/widget/d0$e;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroidx/appcompat/widget/d0;->a:Landroid/graphics/PorterDuff$Mode;
    ...
    sput-object v0, Landroidx/appcompat/widget/d0;->c:Landroidx/appcompat/widget/d0$c;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/d0;->g:Ljava/util/WeakHashMap;

    return-void
.end method

.method private a(Ljava/lang/String;Landroidx/appcompat/widget/d0$d;)V
    .locals 1

    .line 1
    iget-object v0, p0, Landroidx/appcompat/widget/d0;->e:Lc/e/a;
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/d0;->e:Lc/e/a;
...
.method private declared-synchronized b(Landroid/content/Context;JLandroid/graphics/drawable/Drawable;)Z
    ...
    .line 2
    iget-object v0, p0, Landroidx/appcompat/widget/d0;->g:Ljava/util/WeakHashMap;
    ...
    .line 4
    iget-object v1, p0, Landroidx/appcompat/widget/d0;->g:Ljava/util/WeakHashMap;
    ...
    invoke-virtual {v0, p2, p3, p1}, Lc/e/d;->l(JLjava/lang/Object;)V
    :try_end_0
...
.method private d(Landroid/content/Context;)V
    ...
    .line 1
    iget-boolean v0, p0, Landroidx/appcompat/widget/d0;->i:Z
...
.method private f(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    .line 1
    iget-object v0, p0, Landroidx/appcompat/widget/d0;->h:Landroid/util/TypedValue;
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/d0;->h:Landroid/util/TypedValue;
    ...
    .line 7
    :cond_1
    iget-object v3, p0, Landroidx/appcompat/widget/d0;->j:Landroidx/appcompat/widget/d0$e;
    ...
    .line 8
    :cond_2
    invoke-interface {v3, p0, p1, p2}, Landroidx/appcompat/widget/d0$e;->c(Landroidx/appcompat/widget/d0;Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
...
.method public static declared-synchronized h()Landroidx/appcompat/widget/d0;
    ...
    .line 1
    :try_start_0
    sget-object v1, Landroidx/appcompat/widget/d0;->b:Landroidx/appcompat/widget/d0;
    ...
    sput-object v1, Landroidx/appcompat/widget/d0;->b:Landroidx/appcompat/widget/d0;
...
.method private declared-synchronized i(Landroid/content/Context;J)Landroid/graphics/drawable/Drawable;
    ...
    :cond_1
    :try_start_2
    invoke-virtual {v0, p2, p3}, Lc/e/d;->e(J)V
    :try_end_2
...
.method public static declared-synchronized l(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuffColorFilter;
    ...
    .line 1
    :try_start_0
    sget-object v1, Landroidx/appcompat/widget/d0;->c:Landroidx/appcompat/widget/d0$c;

    invoke-virtual {v1, p0, p1}, Landroidx/appcompat/widget/d0$c;->i(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuffColorFilter;
    ...
    .line 3
    invoke-virtual {v1, p0, p1, v2}, Landroidx/appcompat/widget/d0$c;->j(ILandroid/graphics/PorterDuff$Mode;Landroid/graphics/PorterDuffColorFilter;)Landroid/graphics/PorterDuffColorFilter;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method private n(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    .line 3
    invoke-virtual {p1, p2}, Lc/e/h;->g(I)Ljava/lang/Object;
...
.method private static p(Landroidx/appcompat/widget/d0;)V
    ...
    invoke-direct {v0}, Landroidx/appcompat/widget/d0$f;-><init>()V

    const-string v1, "vector"

    invoke-direct {p0, v1, v0}, Landroidx/appcompat/widget/d0;->a(Ljava/lang/String;Landroidx/appcompat/widget/d0$d;)V
...
.method private r(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    .line 2
    iget-object v0, p0, Landroidx/appcompat/widget/d0;->f:Lc/e/h;
    ...
    .line 3
    invoke-virtual {v0, p2}, Lc/e/h;->g(I)Ljava/lang/Object;
    ...
    iget-object v3, p0, Landroidx/appcompat/widget/d0;->e:Lc/e/a;
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/d0;->f:Lc/e/h;
    ...
    .line 19
    iget-object v8, p0, Landroidx/appcompat/widget/d0;->f:Lc/e/h;

    invoke-virtual {v8, p2, v3}, Lc/e/h;->b(ILjava/lang/Object;)V

    .line 20
    iget-object v8, p0, Landroidx/appcompat/widget/d0;->e:Lc/e/a;

    invoke-virtual {v8, v3}, Lc/e/g;->get(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v3

    check-cast v3, Landroidx/appcompat/widget/d0$d;
    ...
    .line 22
    invoke-interface {v3, p1, v1, v7, v8}, Landroidx/appcompat/widget/d0$d;->a(Landroid/content/Context;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;)Landroid/graphics/drawable/Drawable;
    ...
    .line 27
    iget-object p1, p0, Landroidx/appcompat/widget/d0;->f:Lc/e/h;
...
.method private v(Landroid/content/Context;IZLandroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    ...
    .line 2
    invoke-static {p4}, Landroidx/appcompat/widget/w;->a(Landroid/graphics/drawable/Drawable;)Z
    ...
    .line 8
    :cond_1
    iget-object v0, p0, Landroidx/appcompat/widget/d0;->j:Landroidx/appcompat/widget/d0$e;

    if-eqz v0, :cond_2

    invoke-interface {v0, p1, p2, p4}, Landroidx/appcompat/widget/d0$e;->e(Landroid/content/Context;ILandroid/graphics/drawable/Drawable;)Z
    ...
    .line 9
    :cond_2
    invoke-virtual {p0, p1, p2, p4}, Landroidx/appcompat/widget/d0;->x(Landroid/content/Context;ILandroid/graphics/drawable/Drawable;)Z
...
.method static w(Landroid/graphics/drawable/Drawable;Landroidx/appcompat/widget/l0;[I)V
    ...
    .line 1
    invoke-static {p0}, Landroidx/appcompat/widget/w;->a(Landroid/graphics/drawable/Drawable;)Z
    ...
    :cond_4
    sget-object p1, Landroidx/appcompat/widget/d0;->a:Landroid/graphics/PorterDuff$Mode;
...
.method declared-synchronized k(Landroid/content/Context;IZ)Landroid/graphics/drawable/Drawable;
    ...
    .line 5
    invoke-direct {p0, p1, p2, p3, v0}, Landroidx/appcompat/widget/d0;->v(Landroid/content/Context;IZLandroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    ...
    .line 6
    invoke-static {v0}, Landroidx/appcompat/widget/w;->b(Landroid/graphics/drawable/Drawable;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method declared-synchronized m(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    :cond_0
    invoke-interface {v0, p1, p2}, Landroidx/appcompat/widget/d0$e;->d(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
...
.method o(I)Landroid/graphics/PorterDuff$Mode;
    ...
    :cond_0
    invoke-interface {v0, p1}, Landroidx/appcompat/widget/d0$e;->b(I)Landroid/graphics/PorterDuff$Mode;
...
.method declared-synchronized t(Landroid/content/Context;Landroidx/appcompat/widget/s0;I)Landroid/graphics/drawable/Drawable;
    .locals 1
    ...
    .line 2
    invoke-virtual {p2, p3}, Landroidx/appcompat/widget/s0;->d(I)Landroid/graphics/drawable/Drawable;
    ...
    .line 3
    invoke-direct {p0, p1, p3, p2, v0}, Landroidx/appcompat/widget/d0;->v(Landroid/content/Context;IZLandroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
...
.method public declared-synchronized u(Landroidx/appcompat/widget/d0$e;)V
    .locals 0
    ...
    .line 1
    :try_start_0
    iput-object p1, p0, Landroidx/appcompat/widget/d0;->j:Landroidx/appcompat/widget/d0$e;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method x(Landroid/content/Context;ILandroid/graphics/drawable/Drawable;)Z
    ...
    invoke-interface {v0, p1, p2, p3}, Landroidx/appcompat/widget/d0$e;->a(Landroid/content/Context;ILandroid/graphics/drawable/Drawable;)Z
