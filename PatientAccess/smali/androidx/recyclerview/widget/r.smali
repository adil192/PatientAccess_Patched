...
.method private l(Landroidx/recyclerview/widget/RecyclerView$p;Landroidx/recyclerview/widget/q;)Landroid/view/View;
    .locals 8
...
.method private m(Landroidx/recyclerview/widget/RecyclerView$p;)Landroidx/recyclerview/widget/q;
    .locals 1
    ...
    iget-object v0, v0, Landroidx/recyclerview/widget/q;->a:Landroidx/recyclerview/widget/RecyclerView$p;

    if-eq v0, p1, :cond_1

    .line 2
    :cond_0
    invoke-static {p1}, Landroidx/recyclerview/widget/q;->a(Landroidx/recyclerview/widget/RecyclerView$p;)Landroidx/recyclerview/widget/q;
...
.method private n(Landroidx/recyclerview/widget/RecyclerView$p;)Landroidx/recyclerview/widget/q;
    .locals 1
    ...
    .line 2
    invoke-direct {p0, p1}, Landroidx/recyclerview/widget/r;->o(Landroidx/recyclerview/widget/RecyclerView$p;)Landroidx/recyclerview/widget/q;
    ...
    .line 4
    invoke-direct {p0, p1}, Landroidx/recyclerview/widget/r;->m(Landroidx/recyclerview/widget/RecyclerView$p;)Landroidx/recyclerview/widget/q;
...
.method private o(Landroidx/recyclerview/widget/RecyclerView$p;)Landroidx/recyclerview/widget/q;
    .locals 1
    ...
    .line 2
    :cond_0
    invoke-static {p1}, Landroidx/recyclerview/widget/q;->c(Landroidx/recyclerview/widget/RecyclerView$p;)Landroidx/recyclerview/widget/q;
...
.method public f(Landroidx/recyclerview/widget/RecyclerView$p;)Landroid/view/View;
    ...
    invoke-direct {p0, p1, v0}, Landroidx/recyclerview/widget/r;->l(Landroidx/recyclerview/widget/RecyclerView$p;Landroidx/recyclerview/widget/q;)Landroid/view/View;
...
.method public g(Landroidx/recyclerview/widget/RecyclerView$p;II)I
    ...
    .line 2
    :cond_0
    invoke-direct {p0, p1}, Landroidx/recyclerview/widget/r;->n(Landroidx/recyclerview/widget/RecyclerView$p;)Landroidx/recyclerview/widget/q;
    ...
    .line 6
    :cond_5
    invoke-direct {p0, p1, p2, p3}, Landroidx/recyclerview/widget/r;->p(Landroidx/recyclerview/widget/RecyclerView$p;II)Z
    ...
    .line 10
    invoke-direct {p0, p1}, Landroidx/recyclerview/widget/r;->q(Landroidx/recyclerview/widget/RecyclerView$p;)Z
