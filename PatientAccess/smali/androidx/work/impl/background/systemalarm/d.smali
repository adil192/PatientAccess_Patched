...
.implements Landroidx/work/impl/utils/l$b;
...
# instance fields
.field private final Q3:Landroidx/work/impl/m/d;

.field private final R3:Ljava/lang/Object;

.field private S3:I

.field private T3:Landroid/os/PowerManager$WakeLock;
...
.field private final y:Landroidx/work/impl/background/systemalarm/e;
...
.method constructor <init>(Landroid/content/Context;ILjava/lang/String;Landroidx/work/impl/background/systemalarm/e;)V
    ...
    .line 4
    iput-object p4, p0, Landroidx/work/impl/background/systemalarm/d;->y:Landroidx/work/impl/background/systemalarm/e;

    .line 5
    iput-object p3, p0, Landroidx/work/impl/background/systemalarm/d;->x:Ljava/lang/String;

    .line 6
    invoke-virtual {p4}, Landroidx/work/impl/background/systemalarm/e;->f()Landroidx/work/impl/utils/n/a;
    ...
    invoke-direct {p3, p1, p2, p0}, Landroidx/work/impl/m/d;-><init>(Landroid/content/Context;Landroidx/work/impl/utils/n/a;Landroidx/work/impl/m/c;)V

    iput-object p3, p0, Landroidx/work/impl/background/systemalarm/d;->Q3:Landroidx/work/impl/m/d;

    const/4 p1, 0x0

    .line 8
    iput-boolean p1, p0, Landroidx/work/impl/background/systemalarm/d;->U3:Z

    .line 9
    iput p1, p0, Landroidx/work/impl/background/systemalarm/d;->S3:I
    ...
    iput-object p1, p0, Landroidx/work/impl/background/systemalarm/d;->R3:Ljava/lang/Object;
...
.method private b()V
    ...
    .line 1
    iget-object v0, p0, Landroidx/work/impl/background/systemalarm/d;->R3:Ljava/lang/Object;

    monitor-enter v0

    .line 2
    :try_start_0
    iget-object v1, p0, Landroidx/work/impl/background/systemalarm/d;->Q3:Landroidx/work/impl/m/d;

    invoke-virtual {v1}, Landroidx/work/impl/m/d;->e()V

    .line 3
    iget-object v1, p0, Landroidx/work/impl/background/systemalarm/d;->y:Landroidx/work/impl/background/systemalarm/e;

    invoke-virtual {v1}, Landroidx/work/impl/background/systemalarm/e;->h()Landroidx/work/impl/utils/l;

    move-result-object v1

    iget-object v2, p0, Landroidx/work/impl/background/systemalarm/d;->x:Ljava/lang/String;

    invoke-virtual {v1, v2}, Landroidx/work/impl/utils/l;->c(Ljava/lang/String;)V

    .line 4
    iget-object v1, p0, Landroidx/work/impl/background/systemalarm/d;->T3:Landroid/os/PowerManager$WakeLock;
    ...
    iget-object v5, p0, Landroidx/work/impl/background/systemalarm/d;->T3:Landroid/os/PowerManager$WakeLock;
    ...
    iget-object v7, p0, Landroidx/work/impl/background/systemalarm/d;->x:Ljava/lang/String;
...
.method private g()V
    ...
    .line 2
    :try_start_0
    iget v1, p0, Landroidx/work/impl/background/systemalarm/d;->S3:I
    ...
    .line 3
    iput v2, p0, Landroidx/work/impl/background/systemalarm/d;->S3:I
    ...
    iget-object v5, p0, Landroidx/work/impl/background/systemalarm/d;->x:Ljava/lang/String;
    ...
    .line 8
    iget-object v5, p0, Landroidx/work/impl/background/systemalarm/d;->y:Landroidx/work/impl/background/systemalarm/e;
    ...
    iget-object v6, p0, Landroidx/work/impl/background/systemalarm/d;->x:Ljava/lang/String;
    ...
    .line 14
    iget-object v2, p0, Landroidx/work/impl/background/systemalarm/d;->y:Landroidx/work/impl/background/systemalarm/e;
...
.method d()V
    ...
    iget-object v3, p0, Landroidx/work/impl/background/systemalarm/d;->x:Ljava/lang/String;
    ...
    iput-object v0, p0, Landroidx/work/impl/background/systemalarm/d;->T3:Landroid/os/PowerManager$WakeLock;
    ...
    iget-object v3, p0, Landroidx/work/impl/background/systemalarm/d;->T3:Landroid/os/PowerManager$WakeLock;
    ...
    .line 7
    iget-object v0, p0, Landroidx/work/impl/background/systemalarm/d;->T3:Landroid/os/PowerManager$WakeLock;

    invoke-virtual {v0}, Landroid/os/PowerManager$WakeLock;->acquire()V

    .line 8
    iget-object v0, p0, Landroidx/work/impl/background/systemalarm/d;->y:Landroidx/work/impl/background/systemalarm/e;
    ...
    iget-object v1, p0, Landroidx/work/impl/background/systemalarm/d;->x:Ljava/lang/String;
    ...
    iput-boolean v1, p0, Landroidx/work/impl/background/systemalarm/d;->U3:Z
    ...
    .line 15
    iget-object v0, p0, Landroidx/work/impl/background/systemalarm/d;->x:Ljava/lang/String;
...
.method public e(Ljava/lang/String;Z)V
    ...
    iget-object p2, p0, Landroidx/work/impl/background/systemalarm/d;->x:Ljava/lang/String;
    ...
    .line 4
    iget-object p2, p0, Landroidx/work/impl/background/systemalarm/d;->y:Landroidx/work/impl/background/systemalarm/e;
    ...
    .line 5
    :cond_0
    iget-boolean p1, p0, Landroidx/work/impl/background/systemalarm/d;->U3:Z
...
.method public f(Ljava/util/List;)V
    ...
    .line 2
    :cond_0
    iget-object p1, p0, Landroidx/work/impl/background/systemalarm/d;->R3:Ljava/lang/Object;

    monitor-enter p1

    .line 3
    :try_start_0
    iget v0, p0, Landroidx/work/impl/background/systemalarm/d;->S3:I
    ...
    .line 4
    iput v1, p0, Landroidx/work/impl/background/systemalarm/d;->S3:I
    ...
    invoke-virtual {v0}, Landroidx/work/impl/background/systemalarm/e;->h()Landroidx/work/impl/utils/l;
    ...
    .line 8
    invoke-virtual {v0, v1, v2, v3, p0}, Landroidx/work/impl/utils/l;->b(Ljava/lang/String;JLandroidx/work/impl/utils/l$b;)V
