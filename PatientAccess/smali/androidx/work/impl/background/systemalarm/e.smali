...
# instance fields
.field private final Q3:Landroidx/work/impl/j;

.field final R3:Landroidx/work/impl/background/systemalarm/b;

.field private final S3:Landroid/os/Handler;

.field final T3:Ljava/util/List;
...
.field U3:Landroid/content/Intent;

.field private V3:Landroidx/work/impl/background/systemalarm/e$c;

.field final d:Landroid/content/Context;

.field private final q:Landroidx/work/impl/utils/n/a;

.field private final x:Landroidx/work/impl/utils/l;

.field private final y:Landroidx/work/impl/d;
...
.method constructor <init>(Landroid/content/Context;Landroidx/work/impl/d;Landroidx/work/impl/j;)V
    ...
    iput-object v1, p0, Landroidx/work/impl/background/systemalarm/e;->R3:Landroidx/work/impl/background/systemalarm/b;
    ...
    iput-object v0, p0, Landroidx/work/impl/background/systemalarm/e;->x:Landroidx/work/impl/utils/l;
    ...
    :goto_0
    iput-object p3, p0, Landroidx/work/impl/background/systemalarm/e;->Q3:Landroidx/work/impl/j;
    ...
    .line 7
    :cond_1
    invoke-virtual {p3}, Landroidx/work/impl/j;->q()Landroidx/work/impl/d;

    move-result-object p2

    :goto_1
    iput-object p2, p0, Landroidx/work/impl/background/systemalarm/e;->y:Landroidx/work/impl/d;

    .line 8
    invoke-virtual {p3}, Landroidx/work/impl/j;->t()Landroidx/work/impl/utils/n/a;

    move-result-object p1

    iput-object p1, p0, Landroidx/work/impl/background/systemalarm/e;->q:Landroidx/work/impl/utils/n/a;
    ...
    iput-object p1, p0, Landroidx/work/impl/background/systemalarm/e;->T3:Ljava/util/List;

    const/4 p1, 0x0

    .line 11
    iput-object p1, p0, Landroidx/work/impl/background/systemalarm/e;->U3:Landroid/content/Intent;
    ...
    iput-object p1, p0, Landroidx/work/impl/background/systemalarm/e;->S3:Landroid/os/Handler;
...
.method private b()V
    ...
    .line 1
    iget-object v0, p0, Landroidx/work/impl/background/systemalarm/e;->S3:Landroid/os/Handler;
...
.method private i(Ljava/lang/String;)Z
    ...
    .line 2
    iget-object v0, p0, Landroidx/work/impl/background/systemalarm/e;->T3:Ljava/util/List;

    monitor-enter v0

    .line 3
    :try_start_0
    iget-object v1, p0, Landroidx/work/impl/background/systemalarm/e;->T3:Ljava/util/List;
...
.method private l()V
    ...
    .line 5
    iget-object v1, p0, Landroidx/work/impl/background/systemalarm/e;->Q3:Landroidx/work/impl/j;

    invoke-virtual {v1}, Landroidx/work/impl/j;->t()Landroidx/work/impl/utils/n/a;
...
.method public a(Landroid/content/Intent;I)Z
    ...
    .line 9
    iget-object p2, p0, Landroidx/work/impl/background/systemalarm/e;->T3:Ljava/util/List;
...
.method c()V
    ...
    .line 4
    :try_start_0
    iget-object v2, p0, Landroidx/work/impl/background/systemalarm/e;->U3:Landroid/content/Intent;
    ...
    iget-object v6, p0, Landroidx/work/impl/background/systemalarm/e;->U3:Landroid/content/Intent;
    ...
    .line 6
    iget-object v2, p0, Landroidx/work/impl/background/systemalarm/e;->T3:Ljava/util/List;
    ...
    iget-object v4, p0, Landroidx/work/impl/background/systemalarm/e;->U3:Landroid/content/Intent;
    ...
    .line 7
    iput-object v2, p0, Landroidx/work/impl/background/systemalarm/e;->U3:Landroid/content/Intent;
    ...
    :cond_1
    :goto_0
    iget-object v2, p0, Landroidx/work/impl/background/systemalarm/e;->q:Landroidx/work/impl/utils/n/a;
    ...
    .line 10
    iget-object v4, p0, Landroidx/work/impl/background/systemalarm/e;->R3:Landroidx/work/impl/background/systemalarm/b;
    ...
    iget-object v4, p0, Landroidx/work/impl/background/systemalarm/e;->T3:Ljava/util/List;
    ...
    .line 12
    invoke-virtual {v2}, Landroidx/work/impl/utils/f;->a()Z
    ...
    .line 14
    iget-object v1, p0, Landroidx/work/impl/background/systemalarm/e;->V3:Landroidx/work/impl/background/systemalarm/e$c;
...
.method d()Landroidx/work/impl/d;
    .locals 1

    .line 1
    iget-object v0, p0, Landroidx/work/impl/background/systemalarm/e;->y:Landroidx/work/impl/d;
...
.method f()Landroidx/work/impl/utils/n/a;
    .locals 1

    .line 1
    iget-object v0, p0, Landroidx/work/impl/background/systemalarm/e;->q:Landroidx/work/impl/utils/n/a;
...
.method g()Landroidx/work/impl/j;
    ...
    .line 1
    iget-object v0, p0, Landroidx/work/impl/background/systemalarm/e;->Q3:Landroidx/work/impl/j;

    return-object v0
.end method

.method h()Landroidx/work/impl/utils/l;
    .locals 1

    .line 1
    iget-object v0, p0, Landroidx/work/impl/background/systemalarm/e;->x:Landroidx/work/impl/utils/l;
...
.method j()V
    ...
    .line 4
    iput-object v0, p0, Landroidx/work/impl/background/systemalarm/e;->V3:Landroidx/work/impl/background/systemalarm/e$c;
...
.method m(Landroidx/work/impl/background/systemalarm/e$c;)V
    ...
    .line 1
    iget-object v0, p0, Landroidx/work/impl/background/systemalarm/e;->V3:Landroidx/work/impl/background/systemalarm/e$c;
    ...
    .line 3
    :cond_0
    iput-object p1, p0, Landroidx/work/impl/background/systemalarm/e;->V3:Landroidx/work/impl/background/systemalarm/e$c;
