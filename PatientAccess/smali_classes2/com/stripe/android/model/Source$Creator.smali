...
.method public final createFromParcel(Landroid/os/Parcel;)Lcom/stripe/android/model/Source;
    ...
    sget-object v2, Lcom/stripe/android/model/Source$CodeVerification;->CREATOR:Landroid/os/Parcelable$Creator;

    invoke-interface {v2, v0}, Landroid/os/Parcelable$Creator;->createFromParcel(Landroid/os/Parcel;)Ljava/lang/Object;

    move-result-object v2

    check-cast v2, Lcom/stripe/android/model/Source$CodeVerification;
    ...
    const-class v10, Lcom/stripe/android/model/Source$Flow;

    invoke-static {v10, v2}, Ljava/lang/Enum;->valueOf(Ljava/lang/Class;Ljava/lang/String;)Ljava/lang/Enum;

    move-result-object v2

    check-cast v2, Lcom/stripe/android/model/Source$Flow;
    ...
    sget-object v2, Lcom/stripe/android/model/Source$Owner;->CREATOR:Landroid/os/Parcelable$Creator;

    invoke-interface {v2, v0}, Landroid/os/Parcelable$Creator;->createFromParcel(Landroid/os/Parcel;)Ljava/lang/Object;

    move-result-object v2

    check-cast v2, Lcom/stripe/android/model/Source$Owner;
    ...
    sget-object v2, Lcom/stripe/android/model/Source$Receiver;->CREATOR:Landroid/os/Parcelable$Creator;

    invoke-interface {v2, v0}, Landroid/os/Parcelable$Creator;->createFromParcel(Landroid/os/Parcel;)Ljava/lang/Object;

    move-result-object v2

    check-cast v2, Lcom/stripe/android/model/Source$Receiver;
    ...
    sget-object v2, Lcom/stripe/android/model/Source$Redirect;->CREATOR:Landroid/os/Parcelable$Creator;
    ...
    const-class v4, Lcom/stripe/android/model/Source$Status;

    invoke-static {v4, v2}, Ljava/lang/Enum;->valueOf(Ljava/lang/Class;Ljava/lang/String;)Ljava/lang/Enum;

    move-result-object v2

    check-cast v2, Lcom/stripe/android/model/Source$Status;
    ...
    const-class v4, Lcom/stripe/android/model/Source$Usage;

    invoke-static {v4, v2}, Ljava/lang/Enum;->valueOf(Ljava/lang/Class;Ljava/lang/String;)Ljava/lang/Enum;

    move-result-object v2

    check-cast v2, Lcom/stripe/android/model/Source$Usage;
