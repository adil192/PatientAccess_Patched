...
# instance fields
.field private certAlgorithm:Ll/a/a/o;
...
.field private keyAlgorithm:Ll/a/a/o;
...
.field private macAlgorithm:Ll/a/a/f3/b;
...
.method public constructor <init>(Ll/a/c/w/c;Ll/a/a/o;Ll/a/a/o;)V
    .locals 3
    ...
    iput-object v0, p0, Lorg/bouncycastle/jcajce/provider/keystore/pkcs12/PKCS12KeyStoreSpi;->helper:Ll/a/c/w/c;
    ...
    iput-object v0, p0, Lorg/bouncycastle/jcajce/provider/keystore/pkcs12/PKCS12KeyStoreSpi;->macAlgorithm:Ll/a/a/f3/b;
    ...
    iput-object p2, p0, Lorg/bouncycastle/jcajce/provider/keystore/pkcs12/PKCS12KeyStoreSpi;->keyAlgorithm:Ll/a/a/o;

    iput-object p3, p0, Lorg/bouncycastle/jcajce/provider/keystore/pkcs12/PKCS12KeyStoreSpi;->certAlgorithm:Ll/a/a/o;

    :try_start_0
    const-string p2, "X.509"

    invoke-interface {p1, p2}, Ll/a/c/w/c;->e(Ljava/lang/String;)Ljava/security/cert/CertificateFactory;
...
.method static synthetic access$100(Lorg/bouncycastle/jcajce/provider/keystore/pkcs12/PKCS12KeyStoreSpi;Ljava/security/PublicKey;)Ll/a/a/f3/m0;
    .locals 0

    invoke-direct {p0, p1}, Lorg/bouncycastle/jcajce/provider/keystore/pkcs12/PKCS12KeyStoreSpi;->createSubjectKeyId(Ljava/security/PublicKey;)Ll/a/a/f3/m0;
...
.method private calculatePbeMac(Ll/a/a/o;[BI[CZ[B)[B
    .locals 1
    ...
    iget-object p2, p0, Lorg/bouncycastle/jcajce/provider/keystore/pkcs12/PKCS12KeyStoreSpi;->helper:Ll/a/c/w/c;

    invoke-virtual {p1}, Ll/a/a/o;->E()Ljava/lang/String;

    move-result-object p1

    invoke-interface {p2, p1}, Ll/a/c/w/c;->d(Ljava/lang/String;)Ljavax/crypto/Mac;

    move-result-object p1

    new-instance p2, Ll/a/c/i;

    invoke-direct {p2, p4, p5}, Ll/a/c/i;-><init>([CZ)V
...
.method private createCipher(I[CLl/a/a/f3/b;)Ljavax/crypto/Cipher;
    .locals 10
    .annotation system Ldalvik/annotation/Throws;
        value = {
    ...
    invoke-virtual {p3}, Ll/a/a/f3/b;->r()Ll/a/a/e;

    move-result-object p3

    invoke-static {p3}, Ll/a/a/y2/k;->p(Ljava/lang/Object;)Ll/a/a/y2/k;

    move-result-object p3

    invoke-virtual {p3}, Ll/a/a/y2/k;->q()Ll/a/a/y2/h;

    move-result-object v0

    invoke-virtual {v0}, Ll/a/a/y2/h;->q()Ll/a/a/e;

    move-result-object v0

    invoke-static {v0}, Ll/a/a/y2/l;->o(Ljava/lang/Object;)Ll/a/a/y2/l;

    move-result-object v0

    invoke-virtual {p3}, Ll/a/a/y2/k;->o()Ll/a/a/y2/g;
    ...
    iget-object v2, p0, Lorg/bouncycastle/jcajce/provider/keystore/pkcs12/PKCS12KeyStoreSpi;->helper:Ll/a/c/w/c;

    invoke-virtual {p3}, Ll/a/a/y2/k;->q()Ll/a/a/y2/h;

    move-result-object v3

    invoke-virtual {v3}, Ll/a/a/y2/h;->o()Ll/a/a/o;
    ...
    invoke-interface {v2, v3}, Ll/a/c/w/c;->g(Ljava/lang/String;)Ljavax/crypto/SecretKeyFactory;

    move-result-object v2

    invoke-virtual {v0}, Ll/a/a/y2/l;->u()Z
    ...
    invoke-virtual {v0}, Ll/a/a/y2/l;->s()[B

    move-result-object v4

    invoke-virtual {v0}, Ll/a/a/y2/l;->p()Ljava/math/BigInteger;
    ...
    invoke-virtual {v5, v1}, Lorg/bouncycastle/jcajce/provider/keystore/pkcs12/PKCS12KeyStoreSpi$DefaultSecretKeyProvider;->getKeySize(Ll/a/a/f3/b;)I
    ...
    invoke-virtual {v3, v1}, Lorg/bouncycastle/jcajce/provider/keystore/pkcs12/PKCS12KeyStoreSpi$DefaultSecretKeyProvider;->getKeySize(Ll/a/a/f3/b;)I

    move-result v7

    invoke-virtual {v0}, Ll/a/a/y2/l;->r()Ll/a/a/f3/b;
    ...
    invoke-direct/range {v3 .. v8}, Ll/a/c/v/n;-><init>([C[BIILl/a/a/f3/b;)V
    ...
    invoke-virtual {p3}, Ll/a/a/y2/g;->q()Ll/a/a/e;

    move-result-object p3

    instance-of v1, p3, Ll/a/a/p;

    if-eqz v1, :cond_1

    new-instance v1, Ljavax/crypto/spec/IvParameterSpec;

    invoke-static {p3}, Ll/a/a/p;->y(Ljava/lang/Object;)Ll/a/a/p;

    move-result-object p3

    invoke-virtual {p3}, Ll/a/a/p;->B()[B
    ...
    :cond_1
    invoke-static {p3}, Ll/a/a/i2/c;->q(Ljava/lang/Object;)Ll/a/a/i2/c;

    move-result-object p3

    new-instance v1, Ll/a/c/v/h;

    invoke-virtual {p3}, Ll/a/a/i2/c;->o()Ll/a/a/o;

    move-result-object v2

    invoke-virtual {p3}, Ll/a/a/i2/c;->p()[B

    move-result-object p3

    invoke-direct {v1, v2, p3}, Ll/a/c/v/h;-><init>(Ll/a/a/o;[B)V
...
.method private createSafeBag(Ljava/lang/String;Ljava/security/cert/Certificate;)Ll/a/a/y2/v;
    .locals 6
    .annotation system Ldalvik/annotation/Throws;
        value = {
    ...
    new-instance v0, Ll/a/a/y2/b;

    sget-object v1, Ll/a/a/y2/n;->x0:Ll/a/a/o;
    ...
    invoke-direct {v0, v1, v2}, Ll/a/a/y2/b;-><init>(Ll/a/a/o;Ll/a/a/e;)V

    new-instance v1, Ll/a/a/f;

    invoke-direct {v1}, Ll/a/a/f;-><init>()V

    instance-of v2, p2, Ll/a/d/g/n;

    const/4 v3, 0x0

    if-eqz v2, :cond_3

    check-cast p2, Ll/a/d/g/n;

    sget-object v2, Ll/a/a/y2/n;->t0:Ll/a/a/o;

    invoke-interface {p2, v2}, Ll/a/d/g/n;->getBagAttribute(Ll/a/a/o;)Ll/a/a/e;

    move-result-object v4

    check-cast v4, Ll/a/a/o0;

    if-eqz v4, :cond_0

    invoke-virtual {v4}, Ll/a/a/o0;->i()Ljava/lang/String;
    ...
    new-instance v4, Ll/a/a/o0;

    invoke-direct {v4, p1}, Ll/a/a/o0;-><init>(Ljava/lang/String;)V

    invoke-interface {p2, v2, v4}, Ll/a/d/g/n;->setBagAttribute(Ll/a/a/o;Ll/a/a/e;)V

    :cond_1
    invoke-interface {p2}, Ll/a/d/g/n;->getBagAttributeKeys()Ljava/util/Enumeration;
    ...
    sget-object v5, Ll/a/a/y2/n;->u0:Ll/a/a/o;
    ...
    invoke-direct {v3}, Ll/a/a/f;-><init>()V

    invoke-virtual {v3, v4}, Ll/a/a/f;->a(Ll/a/a/e;)V

    new-instance v5, Ll/a/a/d1;

    invoke-interface {p2, v4}, Ll/a/d/g/n;->getBagAttribute(Ll/a/a/o;)Ll/a/a/e;

    move-result-object v4

    invoke-direct {v5, v4}, Ll/a/a/d1;-><init>(Ll/a/a/e;)V

    invoke-virtual {v3, v5}, Ll/a/a/f;->a(Ll/a/a/e;)V

    new-instance v4, Ll/a/a/c1;

    invoke-direct {v4, v3}, Ll/a/a/c1;-><init>(Ll/a/a/f;)V
    ...
    invoke-direct {p2}, Ll/a/a/f;-><init>()V

    sget-object v2, Ll/a/a/y2/n;->t0:Ll/a/a/o;

    invoke-virtual {p2, v2}, Ll/a/a/f;->a(Ll/a/a/e;)V

    new-instance v2, Ll/a/a/d1;

    new-instance v3, Ll/a/a/o0;

    invoke-direct {v3, p1}, Ll/a/a/o0;-><init>(Ljava/lang/String;)V

    invoke-direct {v2, v3}, Ll/a/a/d1;-><init>(Ll/a/a/e;)V
    ...
    invoke-virtual {v1, p1}, Ll/a/a/f;->a(Ll/a/a/e;)V

    :cond_4
    new-instance p1, Ll/a/a/y2/v;

    sget-object p2, Ll/a/a/y2/n;->M1:Ll/a/a/o;

    invoke-virtual {v0}, Ll/a/a/y2/b;->f()Ll/a/a/t;

    move-result-object v0

    new-instance v2, Ll/a/a/d1;

    invoke-direct {v2, v1}, Ll/a/a/d1;-><init>(Ll/a/a/f;)V

    invoke-direct {p1, p2, v0, v2}, Ll/a/a/y2/v;-><init>(Ll/a/a/o;Ll/a/a/e;Ll/a/a/w;)V

    return-object p1
.end method

.method private createSubjectKeyId(Ljava/security/PublicKey;)Ll/a/a/f3/m0;
    .locals 1
    ...
    new-instance v0, Ll/a/a/f3/m0;

    invoke-static {p1}, Lorg/bouncycastle/jcajce/provider/keystore/pkcs12/PKCS12KeyStoreSpi;->getDigest(Ll/a/a/f3/n0;)[B

    move-result-object p1

    invoke-direct {v0, p1}, Ll/a/a/f3/m0;-><init>([B)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method private doStore(Ljava/io/OutputStream;[CZ)V
    ...
    invoke-direct {v8, v4, v5}, Lorg/bouncycastle/jcajce/provider/keystore/pkcs12/PKCS12KeyStoreSpi;->createSafeBag(Ljava/lang/String;Ljava/security/cert/Certificate;)Ll/a/a/y2/v;
    ...
    new-instance v2, Ll/a/a/y2/c;

    sget-object v4, Ll/a/a/y2/n;->Z:Ll/a/a/o;

    if-eqz p3, :cond_1

    new-instance v5, Ll/a/a/y0;

    new-instance v6, Ll/a/a/c1;

    invoke-direct {v6, v3}, Ll/a/a/c1;-><init>(Ll/a/a/f;)V

    invoke-virtual {v6}, Ll/a/a/n;->getEncoded()[B

    move-result-object v3

    invoke-direct {v5, v3}, Ll/a/a/y0;-><init>([B)V

    invoke-direct {v2, v4, v5}, Ll/a/a/y2/c;-><init>(Ll/a/a/o;Ll/a/a/e;)V

    new-instance v3, Ll/a/a/y2/o;

    new-instance v5, Ll/a/a/y2/c;

    new-instance v6, Ll/a/a/y0;

    new-instance v7, Ll/a/a/c1;

    invoke-direct {v7, v2}, Ll/a/a/c1;-><init>(Ll/a/a/e;)V

    invoke-virtual {v7}, Ll/a/a/n;->getEncoded()[B

    move-result-object v2

    invoke-direct {v6, v2}, Ll/a/a/y0;-><init>([B)V

    invoke-direct {v5, v4, v6}, Ll/a/a/y2/c;-><init>(Ll/a/a/o;Ll/a/a/e;)V

    invoke-direct {v3, v5, v1}, Ll/a/a/y2/o;-><init>(Ll/a/a/y2/c;Ll/a/a/y2/i;)V

    invoke-virtual {v3, v0, v10}, Ll/a/a/n;->m(Ljava/io/OutputStream;Ljava/lang/String;)V

    goto :goto_1

    :cond_1
    new-instance v5, Ll/a/a/f0;

    new-instance v6, Ll/a/a/h0;

    invoke-direct {v6, v3}, Ll/a/a/h0;-><init>(Ll/a/a/f;)V

    invoke-virtual {v6}, Ll/a/a/n;->getEncoded()[B

    move-result-object v3

    invoke-direct {v5, v3}, Ll/a/a/f0;-><init>([B)V
    ...
    new-instance v6, Ll/a/a/f0;

    new-instance v7, Ll/a/a/h0;

    invoke-direct {v7, v2}, Ll/a/a/h0;-><init>(Ll/a/a/e;)V

    invoke-virtual {v7}, Ll/a/a/n;->getEncoded()[B

    move-result-object v2

    invoke-direct {v6, v2}, Ll/a/a/f0;-><init>([B)V

    invoke-direct {v5, v4, v6}, Ll/a/a/y2/c;-><init>(Ll/a/a/o;Ll/a/a/e;)V

    invoke-direct {v3, v5, v1}, Ll/a/a/y2/o;-><init>(Ll/a/a/y2/c;Ll/a/a/y2/i;)V

    invoke-virtual {v3, v0, v9}, Ll/a/a/n;->m(Ljava/io/OutputStream;Ljava/lang/String;)V
    ...
    new-instance v14, Ll/a/a/y2/m;

    invoke-direct {v14, v4, v5}, Ll/a/a/y2/m;-><init>([BI)V

    iget-object v4, v8, Lorg/bouncycastle/jcajce/provider/keystore/pkcs12/PKCS12KeyStoreSpi;->keyAlgorithm:Ll/a/a/o;

    invoke-virtual {v4}, Ll/a/a/o;->E()Ljava/lang/String;

    move-result-object v4

    invoke-virtual {v8, v4, v13, v14, v7}, Lorg/bouncycastle/jcajce/provider/keystore/pkcs12/PKCS12KeyStoreSpi;->wrapKey(Ljava/lang/String;Ljava/security/Key;Ll/a/a/y2/m;[C)[B

    move-result-object v4

    new-instance v5, Ll/a/a/f3/b;

    iget-object v15, v8, Lorg/bouncycastle/jcajce/provider/keystore/pkcs12/PKCS12KeyStoreSpi;->keyAlgorithm:Ll/a/a/o;

    invoke-virtual {v14}, Ll/a/a/y2/m;->f()Ll/a/a/t;

    move-result-object v14

    invoke-direct {v5, v15, v14}, Ll/a/a/f3/b;-><init>(Ll/a/a/o;Ll/a/a/e;)V

    new-instance v14, Ll/a/a/y2/f;

    invoke-direct {v14, v5, v4}, Ll/a/a/y2/f;-><init>(Ll/a/a/f3/b;[B)V

    new-instance v4, Ll/a/a/f;

    invoke-direct {v4}, Ll/a/a/f;-><init>()V

    instance-of v5, v13, Ll/a/d/g/n;

    if-eqz v5, :cond_7

    check-cast v13, Ll/a/d/g/n;

    sget-object v5, Ll/a/a/y2/n;->t0:Ll/a/a/o;

    invoke-interface {v13, v5}, Ll/a/d/g/n;->getBagAttribute(Ll/a/a/o;)Ll/a/a/e;

    move-result-object v15

    check-cast v15, Ll/a/a/o0;

    if-eqz v15, :cond_4

    invoke-virtual {v15}, Ll/a/a/o0;->i()Ljava/lang/String;
    ...
    :cond_4
    new-instance v15, Ll/a/a/o0;

    invoke-direct {v15, v6}, Ll/a/a/o0;-><init>(Ljava/lang/String;)V

    invoke-interface {v13, v5, v15}, Ll/a/d/g/n;->setBagAttribute(Ll/a/a/o;Ll/a/a/e;)V
    ...
    invoke-direct {v8, v15}, Lorg/bouncycastle/jcajce/provider/keystore/pkcs12/PKCS12KeyStoreSpi;->createSubjectKeyId(Ljava/security/PublicKey;)Ll/a/a/f3/m0;
    ...
    :cond_6
    invoke-interface {v13}, Ll/a/d/g/n;->getBagAttributeKeys()Ljava/util/Enumeration;
    ...
    check-cast v12, Ll/a/a/o;

    new-instance v15, Ll/a/a/f;

    invoke-direct {v15}, Ll/a/a/f;-><init>()V

    invoke-virtual {v15, v12}, Ll/a/a/f;->a(Ll/a/a/e;)V

    new-instance v11, Ll/a/a/d1;

    invoke-interface {v13, v12}, Ll/a/d/g/n;->getBagAttribute(Ll/a/a/o;)Ll/a/a/e;

    move-result-object v12

    invoke-direct {v11, v12}, Ll/a/a/d1;-><init>(Ll/a/a/e;)V

    invoke-virtual {v15, v11}, Ll/a/a/f;->a(Ll/a/a/e;)V

    new-instance v11, Ll/a/a/c1;

    invoke-direct {v11, v15}, Ll/a/a/c1;-><init>(Ll/a/a/f;)V

    invoke-virtual {v4, v11}, Ll/a/a/f;->a(Ll/a/a/e;)V
    ...
    new-instance v5, Ll/a/a/f;

    invoke-direct {v5}, Ll/a/a/f;-><init>()V

    invoke-virtual {v8, v6}, Lorg/bouncycastle/jcajce/provider/keystore/pkcs12/PKCS12KeyStoreSpi;->engineGetCertificate(Ljava/lang/String;)Ljava/security/cert/Certificate;

    move-result-object v11

    sget-object v12, Ll/a/a/y2/n;->u0:Ll/a/a/o;

    invoke-virtual {v5, v12}, Ll/a/a/f;->a(Ll/a/a/e;)V

    new-instance v12, Ll/a/a/d1;

    invoke-virtual {v11}, Ljava/security/cert/Certificate;->getPublicKey()Ljava/security/PublicKey;

    move-result-object v11

    invoke-direct {v8, v11}, Lorg/bouncycastle/jcajce/provider/keystore/pkcs12/PKCS12KeyStoreSpi;->createSubjectKeyId(Ljava/security/PublicKey;)Ll/a/a/f3/m0;

    move-result-object v11

    invoke-direct {v12, v11}, Ll/a/a/d1;-><init>(Ll/a/a/e;)V

    invoke-virtual {v5, v12}, Ll/a/a/f;->a(Ll/a/a/e;)V

    new-instance v11, Ll/a/a/c1;

    invoke-direct {v11, v5}, Ll/a/a/c1;-><init>(Ll/a/a/f;)V
    ...
    sget-object v11, Ll/a/a/y2/n;->t0:Ll/a/a/o;

    invoke-virtual {v5, v11}, Ll/a/a/f;->a(Ll/a/a/e;)V

    new-instance v11, Ll/a/a/d1;

    new-instance v12, Ll/a/a/o0;

    invoke-direct {v12, v6}, Ll/a/a/o0;-><init>(Ljava/lang/String;)V
    ...
    invoke-direct {v6, v5}, Ll/a/a/c1;-><init>(Ll/a/a/f;)V

    invoke-virtual {v4, v6}, Ll/a/a/f;->a(Ll/a/a/e;)V

    :cond_9
    new-instance v5, Ll/a/a/y2/v;

    sget-object v6, Ll/a/a/y2/n;->L1:Ll/a/a/o;

    invoke-virtual {v14}, Ll/a/a/y2/f;->f()Ll/a/a/t;

    move-result-object v11

    new-instance v12, Ll/a/a/d1;

    invoke-direct {v12, v4}, Ll/a/a/d1;-><init>(Ll/a/a/f;)V

    invoke-direct {v5, v6, v11, v12}, Ll/a/a/y2/v;-><init>(Ll/a/a/o;Ll/a/a/e;Ll/a/a/w;)V
    ...
    invoke-virtual {v3, v10}, Ll/a/a/n;->n(Ljava/lang/String;)[B

    move-result-object v1

    new-instance v11, Ll/a/a/f0;

    invoke-direct {v11, v1}, Ll/a/a/f0;-><init>([B)V
    ...
    new-instance v4, Ll/a/a/y2/m;

    invoke-direct {v4, v1, v5}, Ll/a/a/y2/m;-><init>([BI)V

    new-instance v13, Ll/a/a/f3/b;

    iget-object v1, v8, Lorg/bouncycastle/jcajce/provider/keystore/pkcs12/PKCS12KeyStoreSpi;->certAlgorithm:Ll/a/a/o;

    invoke-virtual {v4}, Ll/a/a/y2/m;->f()Ll/a/a/t;

    move-result-object v4

    invoke-direct {v13, v1, v4}, Ll/a/a/f3/b;-><init>(Ll/a/a/o;Ll/a/a/e;)V
    ...
    new-instance v14, Ll/a/a/y2/b;

    sget-object v15, Ll/a/a/y2/n;->x0:Ll/a/a/o;

    new-instance v12, Ll/a/a/y0;
    ...
    invoke-direct {v12, v4}, Ll/a/a/y0;-><init>([B)V

    invoke-direct {v14, v15, v12}, Ll/a/a/y2/b;-><init>(Ll/a/a/o;Ll/a/a/e;)V

    new-instance v4, Ll/a/a/f;

    invoke-direct {v4}, Ll/a/a/f;-><init>()V

    instance-of v12, v6, Ll/a/d/g/n;

    if-eqz v12, :cond_f

    move-object v12, v6

    check-cast v12, Ll/a/d/g/n;

    sget-object v15, Ll/a/a/y2/n;->t0:Ll/a/a/o;

    invoke-interface {v12, v15}, Ll/a/d/g/n;->getBagAttribute(Ll/a/a/o;)Ll/a/a/e;

    move-result-object v17

    check-cast v17, Ll/a/a/o0;

    if-eqz v17, :cond_b

    invoke-virtual/range {v17 .. v17}, Ll/a/a/o0;->i()Ljava/lang/String;
    ...
    :cond_b
    new-instance v7, Ll/a/a/o0;

    invoke-direct {v7, v5}, Ll/a/a/o0;-><init>(Ljava/lang/String;)V

    invoke-interface {v12, v15, v7}, Ll/a/d/g/n;->setBagAttribute(Ll/a/a/o;Ll/a/a/e;)V

    :cond_c
    sget-object v7, Ll/a/a/y2/n;->u0:Ll/a/a/o;

    invoke-interface {v12, v7}, Ll/a/d/g/n;->getBagAttribute(Ll/a/a/o;)Ll/a/a/e;
    ...
    invoke-interface {v12, v7, v15}, Ll/a/d/g/n;->setBagAttribute(Ll/a/a/o;Ll/a/a/e;)V

    :cond_d
    invoke-interface {v12}, Ll/a/d/g/n;->getBagAttributeKeys()Ljava/util/Enumeration;
    ...
    check-cast v15, Ll/a/a/o;

    move-object/from16 v17, v7

    new-instance v7, Ll/a/a/f;

    invoke-direct {v7}, Ll/a/a/f;-><init>()V

    invoke-virtual {v7, v15}, Ll/a/a/f;->a(Ll/a/a/e;)V

    move-object/from16 v18, v9

    new-instance v9, Ll/a/a/d1;

    invoke-interface {v12, v15}, Ll/a/d/g/n;->getBagAttribute(Ll/a/a/o;)Ll/a/a/e;

    move-result-object v15

    invoke-direct {v9, v15}, Ll/a/a/d1;-><init>(Ll/a/a/e;)V

    invoke-virtual {v7, v9}, Ll/a/a/f;->a(Ll/a/a/e;)V

    new-instance v9, Ll/a/a/c1;

    invoke-direct {v9, v7}, Ll/a/a/c1;-><init>(Ll/a/a/f;)V

    invoke-virtual {v4, v9}, Ll/a/a/f;->a(Ll/a/a/e;)V
    ...
    sget-object v9, Ll/a/a/y2/n;->u0:Ll/a/a/o;
    ...
    invoke-direct {v8, v12}, Lorg/bouncycastle/jcajce/provider/keystore/pkcs12/PKCS12KeyStoreSpi;->createSubjectKeyId(Ljava/security/PublicKey;)Ll/a/a/f3/m0;

    move-result-object v12

    invoke-direct {v9, v12}, Ll/a/a/d1;-><init>(Ll/a/a/e;)V
    ...
    sget-object v9, Ll/a/a/y2/n;->t0:Ll/a/a/o;
    ...
    invoke-direct {v12, v5}, Ll/a/a/o0;-><init>(Ljava/lang/String;)V
    ...
    invoke-direct {v5, v7}, Ll/a/a/c1;-><init>(Ll/a/a/f;)V

    invoke-virtual {v4, v5}, Ll/a/a/f;->a(Ll/a/a/e;)V

    :cond_10
    new-instance v5, Ll/a/a/y2/v;

    sget-object v7, Ll/a/a/y2/n;->M1:Ll/a/a/o;

    invoke-virtual {v14}, Ll/a/a/y2/b;->f()Ll/a/a/t;
    ...
    invoke-direct {v5, v7, v9, v12}, Ll/a/a/y2/v;-><init>(Ll/a/a/o;Ll/a/a/e;Ll/a/a/w;)V
    ...
    :cond_12
    invoke-direct {v8, v5, v6}, Lorg/bouncycastle/jcajce/provider/keystore/pkcs12/PKCS12KeyStoreSpi;->createSafeBag(Ljava/lang/String;Ljava/security/cert/Certificate;)Ll/a/a/y2/v;
    ...
    :cond_15
    new-instance v7, Ll/a/a/y2/b;

    sget-object v9, Ll/a/a/y2/n;->x0:Ll/a/a/o;
    ...
    invoke-direct {v12, v14}, Ll/a/a/y0;-><init>([B)V

    invoke-direct {v7, v9, v12}, Ll/a/a/y2/b;-><init>(Ll/a/a/o;Ll/a/a/e;)V

    new-instance v9, Ll/a/a/f;

    invoke-direct {v9}, Ll/a/a/f;-><init>()V

    instance-of v12, v6, Ll/a/d/g/n;

    if-eqz v12, :cond_17

    check-cast v6, Ll/a/d/g/n;

    invoke-interface {v6}, Ll/a/d/g/n;->getBagAttributeKeys()Ljava/util/Enumeration;
    ...
    check-cast v14, Ll/a/a/o;

    sget-object v15, Ll/a/a/y2/n;->u0:Ll/a/a/o;

    invoke-virtual {v14, v15}, Ll/a/a/t;->s(Ll/a/a/t;)Z
    ...
    invoke-virtual {v15, v14}, Ll/a/a/f;->a(Ll/a/a/e;)V

    move-object/from16 v16, v1

    new-instance v1, Ll/a/a/d1;

    invoke-interface {v6, v14}, Ll/a/d/g/n;->getBagAttribute(Ll/a/a/o;)Ll/a/a/e;

    move-result-object v14

    invoke-direct {v1, v14}, Ll/a/a/d1;-><init>(Ll/a/a/e;)V

    invoke-virtual {v15, v1}, Ll/a/a/f;->a(Ll/a/a/e;)V

    new-instance v1, Ll/a/a/c1;

    invoke-direct {v1, v15}, Ll/a/a/c1;-><init>(Ll/a/a/f;)V

    invoke-virtual {v9, v1}, Ll/a/a/f;->a(Ll/a/a/e;)V
    ...
    new-instance v1, Ll/a/a/y2/v;

    sget-object v6, Ll/a/a/y2/n;->M1:Ll/a/a/o;

    invoke-virtual {v7}, Ll/a/a/y2/b;->f()Ll/a/a/t;

    move-result-object v7

    new-instance v12, Ll/a/a/d1;

    invoke-direct {v12, v9}, Ll/a/a/d1;-><init>(Ll/a/a/f;)V

    invoke-direct {v1, v6, v7, v12}, Ll/a/a/y2/v;-><init>(Ll/a/a/o;Ll/a/a/e;Ll/a/a/w;)V

    invoke-virtual {v3, v1}, Ll/a/a/f;->a(Ll/a/a/e;)V
    :try_end_3
    ...
    invoke-direct {v1, v3}, Ll/a/a/c1;-><init>(Ll/a/a/f;)V

    invoke-virtual {v1, v10}, Ll/a/a/n;->n(Ljava/lang/String;)[B
    ...
    invoke-virtual/range {v1 .. v6}, Lorg/bouncycastle/jcajce/provider/keystore/pkcs12/PKCS12KeyStoreSpi;->cryptData(ZLl/a/a/f3/b;[CZ[B)[B

    move-result-object v1

    new-instance v2, Ll/a/a/y2/e;

    sget-object v3, Ll/a/a/y2/n;->Z:Ll/a/a/o;

    new-instance v4, Ll/a/a/f0;

    invoke-direct {v4, v1}, Ll/a/a/f0;-><init>([B)V

    invoke-direct {v2, v3, v13, v4}, Ll/a/a/y2/e;-><init>(Ll/a/a/o;Ll/a/a/f3/b;Ll/a/a/e;)V

    const/4 v1, 0x2

    new-array v1, v1, [Ll/a/a/y2/c;

    new-instance v4, Ll/a/a/y2/c;

    invoke-direct {v4, v3, v11}, Ll/a/a/y2/c;-><init>(Ll/a/a/o;Ll/a/a/e;)V
    ...
    sget-object v5, Ll/a/a/y2/n;->e0:Ll/a/a/o;

    invoke-virtual {v2}, Ll/a/a/y2/e;->f()Ll/a/a/t;

    move-result-object v2

    invoke-direct {v4, v5, v2}, Ll/a/a/y2/c;-><init>(Ll/a/a/o;Ll/a/a/e;)V

    const/4 v2, 0x1

    aput-object v4, v1, v2

    new-instance v2, Ll/a/a/y2/a;

    invoke-direct {v2, v1}, Ll/a/a/y2/a;-><init>([Ll/a/a/y2/c;)V
    ...
    :goto_a
    invoke-virtual {v2, v1}, Ll/a/a/n;->n(Ljava/lang/String;)[B

    move-result-object v1

    new-instance v9, Ll/a/a/y2/c;

    new-instance v2, Ll/a/a/f0;

    invoke-direct {v2, v1}, Ll/a/a/f0;-><init>([B)V

    invoke-direct {v9, v3, v2}, Ll/a/a/y2/c;-><init>(Ll/a/a/o;Ll/a/a/e;)V
    ...
    invoke-virtual {v9}, Ll/a/a/y2/c;->o()Ll/a/a/e;
    ...
    :try_start_4
    iget-object v1, v8, Lorg/bouncycastle/jcajce/provider/keystore/pkcs12/PKCS12KeyStoreSpi;->macAlgorithm:Ll/a/a/f3/b;
    ...
    invoke-direct/range {v1 .. v7}, Lorg/bouncycastle/jcajce/provider/keystore/pkcs12/PKCS12KeyStoreSpi;->calculatePbeMac(Ll/a/a/o;[BI[CZ[B)[B

    move-result-object v1

    new-instance v2, Ll/a/a/f3/r;

    iget-object v3, v8, Lorg/bouncycastle/jcajce/provider/keystore/pkcs12/PKCS12KeyStoreSpi;->macAlgorithm:Ll/a/a/f3/b;

    invoke-direct {v2, v3, v1}, Ll/a/a/f3/r;-><init>(Ll/a/a/f3/b;[B)V

    new-instance v1, Ll/a/a/y2/i;

    iget v3, v8, Lorg/bouncycastle/jcajce/provider/keystore/pkcs12/PKCS12KeyStoreSpi;->itCount:I

    invoke-direct {v1, v2, v11, v3}, Ll/a/a/y2/i;-><init>(Ll/a/a/f3/r;[BI)V
    :try_end_4
    .catch Ljava/lang/Exception; {:try_start_4 .. :try_end_4} :catch_4

    new-instance v2, Ll/a/a/y2/o;

    invoke-direct {v2, v9, v1}, Ll/a/a/y2/o;-><init>(Ll/a/a/y2/c;Ll/a/a/y2/i;)V
    ...
    :goto_b
    invoke-virtual {v2, v0, v9}, Ll/a/a/n;->m(Ljava/io/OutputStream;Ljava/lang/String;)V
...
.method private static getDigest(Ll/a/a/f3/n0;)[B
    .locals 4
    ...
    invoke-virtual {p0}, Ll/a/a/f3/n0;->r()Ll/a/a/p0;

    move-result-object p0

    invoke-virtual {p0}, Ll/a/a/b;->A()[B
    ...
    invoke-interface {v0, p0, v3, v2}, Ll/a/b/r;->update([BII)V

    invoke-interface {v0, v1, v3}, Ll/a/b/r;->doFinal([BI)I
...
.method private validateIterationCount(Ljava/math/BigInteger;)I
    ...
    invoke-static {v0}, Ll/a/g/l;->a(Ljava/lang/String;)Ljava/math/BigInteger;
...
# virtual methods
.method protected cryptData(ZLl/a/a/f3/b;[CZ[B)[B
    .locals 4
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    :goto_0
    sget-object v1, Ll/a/a/y2/n;->Q1:Ll/a/a/o;
    ...
    invoke-static {p2}, Ll/a/a/y2/m;->p(Ljava/lang/Object;)Ll/a/a/y2/m;
    ...
    invoke-virtual {p2}, Ll/a/a/y2/m;->o()[B

    move-result-object v3

    invoke-virtual {p2}, Ll/a/a/y2/m;->q()Ljava/math/BigInteger;
    ...
    invoke-direct {p2, p3, p4}, Ll/a/c/i;-><init>([CZ)V

    iget-object p3, p0, Lorg/bouncycastle/jcajce/provider/keystore/pkcs12/PKCS12KeyStoreSpi;->helper:Ll/a/c/w/c;

    invoke-virtual {v0}, Ll/a/a/o;->E()Ljava/lang/String;

    move-result-object p4

    invoke-interface {p3, p4}, Ll/a/c/w/c;->c(Ljava/lang/String;)Ljavax/crypto/Cipher;
    ...
    :cond_1
    sget-object p4, Ll/a/a/y2/n;->J:Ll/a/a/o;

    invoke-virtual {v0, p4}, Ll/a/a/t;->s(Ll/a/a/t;)Z
    ...
    :try_start_1
    invoke-direct {p0, p1, p3, p2}, Lorg/bouncycastle/jcajce/provider/keystore/pkcs12/PKCS12KeyStoreSpi;->createCipher(I[CLl/a/a/f3/b;)Ljavax/crypto/Cipher;
...
.method public engineGetCertificateChain(Ljava/lang/String;)[Ljava/security/cert/Certificate;
    ...
    sget-object v3, Ll/a/a/f3/u;->d4:Ll/a/a/o;
    ...
    invoke-virtual {v3}, Ll/a/a/p;->B()[B

    move-result-object v3

    invoke-static {v3}, Ll/a/a/f3/i;->o(Ljava/lang/Object;)Ll/a/a/f3/i;

    move-result-object v3

    invoke-virtual {v3}, Ll/a/a/f3/i;->p()[B
...
.method public engineLoad(Ljava/io/InputStream;[C)V
    ...
    invoke-direct {v0, v1}, Ll/a/a/k;-><init>(Ljava/io/InputStream;)V
    ...
    invoke-static {v0}, Ll/a/a/y2/o;->p(Ljava/lang/Object;)Ll/a/a/y2/o;

    move-result-object v0
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_3

    invoke-virtual {v0}, Ll/a/a/y2/o;->o()Ll/a/a/y2/c;
    ...
    invoke-virtual {v0}, Ll/a/a/y2/o;->q()Ll/a/a/y2/i;
    ...
    invoke-virtual {v0}, Ll/a/a/y2/i;->q()Ll/a/a/f3/r;

    move-result-object v14

    invoke-virtual {v14}, Ll/a/a/f3/r;->o()Ll/a/a/f3/b;

    move-result-object v1

    iput-object v1, v8, Lorg/bouncycastle/jcajce/provider/keystore/pkcs12/PKCS12KeyStoreSpi;->macAlgorithm:Ll/a/a/f3/b;

    invoke-virtual {v0}, Ll/a/a/y2/i;->r()[B

    move-result-object v15

    invoke-virtual {v0}, Ll/a/a/y2/i;->p()Ljava/math/BigInteger;
    ...
    invoke-virtual {v10}, Ll/a/a/y2/c;->o()Ll/a/a/e;
    ...
    invoke-virtual {v14}, Ll/a/a/f3/r;->p()[B

    move-result-object v14

    invoke-static {v1, v14}, Ll/a/g/a;->s([B[B)Z
    ...
    invoke-static {v0, v14}, Ll/a/g/a;->s([B[B)Z
    ...
    invoke-virtual {v10}, Ll/a/a/y2/c;->p()Ll/a/a/o;

    move-result-object v1

    sget-object v2, Ll/a/a/y2/n;->Z:Ll/a/a/o;
    ...
    invoke-static {v1}, Ll/a/a/y2/a;->q(Ljava/lang/Object;)Ll/a/a/y2/a;

    move-result-object v1

    invoke-virtual {v1}, Ll/a/a/y2/a;->p()[Ll/a/a/y2/c;
    ...
    invoke-virtual {v1}, Ll/a/a/y2/c;->p()Ll/a/a/o;
    ...
    invoke-virtual {v1}, Ll/a/a/y2/c;->o()Ll/a/a/e;
    ...
    invoke-static {v3}, Ll/a/a/y2/v;->r(Ljava/lang/Object;)Ll/a/a/y2/v;

    move-result-object v3

    invoke-virtual {v3}, Ll/a/a/y2/v;->p()Ll/a/a/o;

    move-result-object v4

    sget-object v5, Ll/a/a/y2/n;->L1:Ll/a/a/o;
    ...
    invoke-virtual {v3}, Ll/a/a/y2/v;->q()Ll/a/a/e;

    move-result-object v4

    invoke-static {v4}, Ll/a/a/y2/f;->q(Ljava/lang/Object;)Ll/a/a/y2/f;

    move-result-object v4

    invoke-virtual {v4}, Ll/a/a/y2/f;->p()Ll/a/a/f3/b;

    move-result-object v5

    invoke-virtual {v4}, Ll/a/a/y2/f;->o()[B

    move-result-object v4

    invoke-virtual {v8, v5, v4, v9, v0}, Lorg/bouncycastle/jcajce/provider/keystore/pkcs12/PKCS12KeyStoreSpi;->unwrapKey(Ll/a/a/f3/b;[B[CZ)Ljava/security/PrivateKey;

    move-result-object v4

    invoke-virtual {v3}, Ll/a/a/y2/v;->o()Ll/a/a/w;
    ...
    invoke-virtual {v3}, Ll/a/a/w;->E()Ljava/util/Enumeration;
    ...
    check-cast v7, Ll/a/a/u;

    invoke-virtual {v7, v13}, Ll/a/a/u;->B(I)Ll/a/a/e;

    move-result-object v18

    move-object/from16 v13, v18

    check-cast v13, Ll/a/a/o;

    invoke-virtual {v7, v12}, Ll/a/a/u;->B(I)Ll/a/a/e;

    move-result-object v7

    check-cast v7, Ll/a/a/w;

    invoke-virtual {v7}, Ll/a/a/w;->size()I
    ...
    invoke-virtual {v7, v12}, Ll/a/a/w;->C(I)Ll/a/a/e;

    move-result-object v7

    check-cast v7, Ll/a/a/t;

    instance-of v12, v4, Ll/a/d/g/n;
    ...
    invoke-interface {v12, v13}, Ll/a/d/g/n;->getBagAttribute(Ll/a/a/o;)Ll/a/a/e;

    move-result-object v20

    if-eqz v20, :cond_7

    invoke-interface/range {v20 .. v20}, Ll/a/a/e;->f()Ll/a/a/t;

    move-result-object v12

    invoke-virtual {v12, v7}, Ll/a/a/t;->s(Ll/a/a/t;)Z
    ...
    :cond_7
    invoke-interface {v12, v13, v7}, Ll/a/d/g/n;->setBagAttribute(Ll/a/a/o;Ll/a/a/e;)V
    ...
    :cond_9
    :goto_5
    sget-object v12, Ll/a/a/y2/n;->t0:Ll/a/a/o;

    invoke-virtual {v13, v12}, Ll/a/a/t;->s(Ll/a/a/t;)Z

    move-result v12

    if-eqz v12, :cond_a

    check-cast v7, Ll/a/a/o0;

    invoke-virtual {v7}, Ll/a/a/o0;->i()Ljava/lang/String;
    ...
    invoke-virtual/range {v17 .. v17}, Ll/a/a/p;->B()[B

    move-result-object v7

    invoke-static {v7}, Ll/a/g/q/f;->d([B)[B
    ...
    sget-object v5, Ll/a/a/y2/n;->M1:Ll/a/a/o;
    ...
    invoke-static {v3}, Ll/a/a/d3/a;->c(Ljava/lang/Object;)Ljava/lang/String;
    ...
    sget-object v2, Ll/a/a/y2/n;->e0:Ll/a/a/o;
    ...
    invoke-static {v1}, Ll/a/a/y2/e;->q(Ljava/lang/Object;)Ll/a/a/y2/e;

    move-result-object v1

    const/4 v2, 0x0

    invoke-virtual {v1}, Ll/a/a/y2/e;->p()Ll/a/a/f3/b;

    move-result-object v3

    invoke-virtual {v1}, Ll/a/a/y2/e;->o()Ll/a/a/p;
    ...
    invoke-virtual {v1, v12}, Ll/a/a/u;->B(I)Ll/a/a/e;

    move-result-object v2

    invoke-static {v2}, Ll/a/a/y2/v;->r(Ljava/lang/Object;)Ll/a/a/y2/v;

    move-result-object v2

    invoke-virtual {v2}, Ll/a/a/y2/v;->p()Ll/a/a/o;

    move-result-object v3

    sget-object v4, Ll/a/a/y2/n;->M1:Ll/a/a/o;
    ...
    sget-object v4, Ll/a/a/y2/n;->L1:Ll/a/a/o;
    ...
    invoke-virtual {v2}, Ll/a/a/y2/v;->q()Ll/a/a/e;

    move-result-object v3

    invoke-static {v3}, Ll/a/a/y2/f;->q(Ljava/lang/Object;)Ll/a/a/y2/f;

    move-result-object v3

    invoke-virtual {v3}, Ll/a/a/y2/f;->p()Ll/a/a/f3/b;

    move-result-object v4

    invoke-virtual {v3}, Ll/a/a/y2/f;->o()[B

    move-result-object v3

    invoke-virtual {v8, v4, v3, v9, v0}, Lorg/bouncycastle/jcajce/provider/keystore/pkcs12/PKCS12KeyStoreSpi;->unwrapKey(Ll/a/a/f3/b;[B[CZ)Ljava/security/PrivateKey;

    move-result-object v3

    move-object v4, v3

    check-cast v4, Ll/a/d/g/n;

    invoke-virtual {v2}, Ll/a/a/y2/v;->o()Ll/a/a/w;

    move-result-object v2

    invoke-virtual {v2}, Ll/a/a/w;->E()Ljava/util/Enumeration;
    ...
    invoke-virtual {v7, v0}, Ll/a/a/u;->B(I)Ll/a/a/e;
    ...
    invoke-virtual {v7, v1}, Ll/a/a/u;->B(I)Ll/a/a/e;
    ...
    invoke-virtual {v7, v1}, Ll/a/a/w;->C(I)Ll/a/a/e;

    move-result-object v7

    check-cast v7, Ll/a/a/t;

    invoke-interface {v4, v0}, Ll/a/d/g/n;->getBagAttribute(Ll/a/a/o;)Ll/a/a/e;
    ...
    invoke-virtual {v1, v7}, Ll/a/a/t;->s(Ll/a/a/t;)Z
    ...
    :cond_16
    invoke-interface {v4, v0, v7}, Ll/a/d/g/n;->setBagAttribute(Ll/a/a/o;Ll/a/a/e;)V
    ...
    :goto_a
    sget-object v1, Ll/a/a/y2/n;->t0:Ll/a/a/o;
    ...
    :cond_18
    sget-object v1, Ll/a/a/y2/n;->u0:Ll/a/a/o;
    ...
    sget-object v1, Ll/a/a/y2/n;->K1:Ll/a/a/o;
    ...
    invoke-static {v0}, Lorg/bouncycastle/jce/provider/BouncyCastleProvider;->getPrivateKey(Ll/a/a/y2/p;)Ljava/security/PrivateKey;

    move-result-object v0

    move-object v1, v0

    check-cast v1, Ll/a/d/g/n;
    ...
    invoke-virtual {v5, v6}, Ll/a/a/u;->B(I)Ll/a/a/e;

    move-result-object v7

    invoke-static {v7}, Ll/a/a/o;->F(Ljava/lang/Object;)Ll/a/a/o;
    ...
    invoke-static {v5}, Ll/a/a/w;->A(Ljava/lang/Object;)Ll/a/a/w;

    move-result-object v5

    invoke-virtual {v5}, Ll/a/a/w;->size()I
    ...
    invoke-virtual {v5, v6}, Ll/a/a/w;->C(I)Ll/a/a/e;

    move-result-object v5

    check-cast v5, Ll/a/a/t;

    invoke-interface {v1, v7}, Ll/a/d/g/n;->getBagAttribute(Ll/a/a/o;)Ll/a/a/e;
    ...
    invoke-virtual {v6, v5}, Ll/a/a/t;->s(Ll/a/a/t;)Z
    ...
    :cond_1f
    invoke-interface {v1, v7, v5}, Ll/a/d/g/n;->setBagAttribute(Ll/a/a/o;Ll/a/a/e;)V

    :goto_d
    sget-object v6, Ll/a/a/y2/n;->t0:Ll/a/a/o;

    invoke-virtual {v7, v6}, Ll/a/a/t;->s(Ll/a/a/t;)Z

    move-result v6

    if-eqz v6, :cond_20

    check-cast v5, Ll/a/a/o0;

    invoke-virtual {v5}, Ll/a/a/o0;->i()Ljava/lang/String;
    ...
    :cond_20
    sget-object v6, Ll/a/a/y2/n;->u0:Ll/a/a/o;
    ...
    invoke-static {v2}, Ll/a/g/q/f;->d([B)[B
    ...
    invoke-static {v2}, Ll/a/a/d3/a;->c(Ljava/lang/Object;)Ljava/lang/String;
    ...
    invoke-virtual {v3}, Ll/a/a/y2/c;->p()Ll/a/a/o;
    ...
    invoke-virtual {v2}, Ll/a/a/y2/c;->o()Ll/a/a/e;
    ...
    check-cast v0, Ll/a/a/y2/v;

    invoke-virtual {v0}, Ll/a/a/y2/v;->q()Ll/a/a/e;

    move-result-object v2

    invoke-static {v2}, Ll/a/a/y2/b;->q(Ljava/lang/Object;)Ll/a/a/y2/b;

    move-result-object v2

    invoke-virtual {v2}, Ll/a/a/y2/b;->o()Ll/a/a/o;

    move-result-object v3

    sget-object v4, Ll/a/a/y2/n;->x0:Ll/a/a/o;
    ...
    invoke-virtual {v2}, Ll/a/a/y2/b;->p()Ll/a/a/e;
    ...
    invoke-virtual {v0}, Ll/a/a/y2/v;->o()Ll/a/a/w;
    ...
    invoke-virtual {v0}, Ll/a/a/w;->E()Ljava/util/Enumeration;
    ...
    invoke-virtual {v5, v9}, Ll/a/a/u;->B(I)Ll/a/a/e;
    ...
    instance-of v10, v2, Ll/a/d/g/n;

    if-eqz v10, :cond_2b

    move-object v10, v2

    check-cast v10, Ll/a/d/g/n;

    invoke-interface {v10, v7}, Ll/a/d/g/n;->getBagAttribute(Ll/a/a/o;)Ll/a/a/e;

    move-result-object v13

    if-eqz v13, :cond_2a

    invoke-interface {v13}, Ll/a/a/e;->f()Ll/a/a/t;

    move-result-object v10

    invoke-virtual {v10, v5}, Ll/a/a/t;->s(Ll/a/a/t;)Z
    ...
    :cond_2a
    invoke-interface {v10, v7, v5}, Ll/a/d/g/n;->setBagAttribute(Ll/a/a/o;Ll/a/a/e;)V

    :cond_2b
    :goto_12
    sget-object v10, Ll/a/a/y2/n;->t0:Ll/a/a/o;

    invoke-virtual {v7, v10}, Ll/a/a/t;->s(Ll/a/a/t;)Z
    ...
    :cond_2c
    sget-object v10, Ll/a/a/y2/n;->u0:Ll/a/a/o;
    ...
    invoke-direct {v8, v3}, Lorg/bouncycastle/jcajce/provider/keystore/pkcs12/PKCS12KeyStoreSpi;->createSubjectKeyId(Ljava/security/PublicKey;)Ll/a/a/f3/m0;

    move-result-object v3

    invoke-virtual {v3}, Ll/a/a/f3/m0;->o()[B

    move-result-object v3

    invoke-static {v3}, Ll/a/g/q/f;->d([B)[B
    ...
    invoke-static {v4}, Ll/a/g/q/f;->d([B)[B
...
.method public engineStore(Ljava/security/KeyStore$LoadStoreParameter;)V
    ...
    check-cast v0, Ll/a/c/k;

    goto :goto_1

    :cond_2
    new-instance v0, Ll/a/c/k;
    ...
    invoke-direct {v0, v2, v3, v1}, Ll/a/c/k;-><init>(Ljava/io/OutputStream;Ljava/security/KeyStore$ProtectionParameter;Z)V
    ...
    :goto_2
    invoke-virtual {v0}, Ll/a/c/k;->getOutputStream()Ljava/io/OutputStream;

    move-result-object v1

    invoke-virtual {v0}, Ll/a/c/k;->isForDEREncoding()Z
...
.method protected unwrapKey(Ll/a/a/f3/b;[B[CZ)Ljava/security/PrivateKey;
    .locals 6
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-static {p1}, Ll/a/a/y2/m;->p(Ljava/lang/Object;)Ll/a/a/y2/m;

    move-result-object p1

    new-instance v1, Ljavax/crypto/spec/PBEParameterSpec;

    invoke-virtual {p1}, Ll/a/a/y2/m;->o()[B

    move-result-object v5

    invoke-virtual {p1}, Ll/a/a/y2/m;->q()Ljava/math/BigInteger;
    ...
    iget-object p1, p0, Lorg/bouncycastle/jcajce/provider/keystore/pkcs12/PKCS12KeyStoreSpi;->helper:Ll/a/c/w/c;

    invoke-virtual {v0}, Ll/a/a/o;->E()Ljava/lang/String;

    move-result-object v0

    invoke-interface {p1, v0}, Ll/a/c/w/c;->c(Ljava/lang/String;)Ljavax/crypto/Cipher;

    move-result-object p1

    new-instance v0, Ll/a/c/i;

    invoke-direct {v0, p3, p4}, Ll/a/c/i;-><init>([CZ)V
    ...
    invoke-direct {p0, v4, p3, p1}, Lorg/bouncycastle/jcajce/provider/keystore/pkcs12/PKCS12KeyStoreSpi;->createCipher(I[CLl/a/a/f3/b;)Ljavax/crypto/Cipher;
...
.method protected wrapKey(Ljava/lang/String;Ljava/security/Key;Ll/a/a/y2/m;[C)[B
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    :try_start_0
    iget-object p4, p0, Lorg/bouncycastle/jcajce/provider/keystore/pkcs12/PKCS12KeyStoreSpi;->helper:Ll/a/c/w/c;

    invoke-interface {p4, p1}, Ll/a/c/w/c;->g(Ljava/lang/String;)Ljavax/crypto/SecretKeyFactory;

    move-result-object p4

    new-instance v1, Ljavax/crypto/spec/PBEParameterSpec;

    invoke-virtual {p3}, Ll/a/a/y2/m;->o()[B

    move-result-object v2

    invoke-virtual {p3}, Ll/a/a/y2/m;->q()Ljava/math/BigInteger;
    ...
    invoke-interface {p3, p1}, Ll/a/c/w/c;->c(Ljava/lang/String;)Ljavax/crypto/Cipher;
