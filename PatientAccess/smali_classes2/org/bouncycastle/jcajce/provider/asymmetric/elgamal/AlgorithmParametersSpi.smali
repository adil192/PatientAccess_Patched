...
.method protected engineGetEncoded()[B
    ...
    iget-object v1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/elgamal/AlgorithmParametersSpi;->currentSpec:Ll/a/d/h/i;

    invoke-virtual {v1}, Ll/a/d/h/i;->b()Ljava/math/BigInteger;

    move-result-object v1

    iget-object v2, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/elgamal/AlgorithmParametersSpi;->currentSpec:Ll/a/d/h/i;

    invoke-virtual {v2}, Ll/a/d/h/i;->a()Ljava/math/BigInteger;

    move-result-object v2

    invoke-direct {v0, v1, v2}, Ll/a/a/x2/a;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;)V
...
.method protected engineInit(Ljava/security/spec/AlgorithmParameterSpec;)V
    ...
    iput-object p1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/elgamal/AlgorithmParametersSpi;->currentSpec:Ll/a/d/h/i;
    ...
    iput-object v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/elgamal/AlgorithmParametersSpi;->currentSpec:Ll/a/d/h/i;
...
.method protected engineInit([B)V
    ...
    invoke-static {p1}, Ll/a/a/x2/a;->p(Ljava/lang/Object;)Ll/a/a/x2/a;

    move-result-object p1

    new-instance v1, Ll/a/d/h/i;

    invoke-virtual {p1}, Ll/a/a/x2/a;->q()Ljava/math/BigInteger;

    move-result-object v2

    invoke-virtual {p1}, Ll/a/a/x2/a;->o()Ljava/math/BigInteger;

    move-result-object p1

    invoke-direct {v1, v2, p1}, Ll/a/d/h/i;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;)V

    iput-object v1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/elgamal/AlgorithmParametersSpi;->currentSpec:Ll/a/d/h/i;
    :try_end_0
...
.method protected localEngineGetParameterSpec(Ljava/lang/Class;)Ljava/security/spec/AlgorithmParameterSpec;
    ...
    iget-object v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/elgamal/AlgorithmParametersSpi;->currentSpec:Ll/a/d/h/i;
    ...
    invoke-virtual {v1}, Ll/a/d/h/i;->a()Ljava/math/BigInteger;
    ...
    :cond_2
    :goto_0
    iget-object p1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/elgamal/AlgorithmParametersSpi;->currentSpec:Ll/a/d/h/i;
