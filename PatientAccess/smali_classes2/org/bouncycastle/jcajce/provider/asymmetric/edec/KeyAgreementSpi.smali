...
# instance fields
.field private agreement:Ll/a/b/d0;

.field private dhuSpec:Ll/a/c/v/e;
...
.method constructor <init>(Ljava/lang/String;)V
    ...
    invoke-direct {p0, p1, v0}, Lorg/bouncycastle/jcajce/provider/asymmetric/util/BaseAgreementSpi;-><init>(Ljava/lang/String;Ll/a/b/p;)V

    return-void
.end method

.method constructor <init>(Ljava/lang/String;Ll/a/b/p;)V
    .locals 0
...
.method private getAgreement(Ljava/lang/String;)Ll/a/b/d0;
    .locals 2
    ...
    new-instance p1, Ll/a/b/k0/k;

    new-instance v0, Ll/a/b/k0/j;

    invoke-direct {v0}, Ll/a/b/k0/j;-><init>()V

    invoke-direct {p1, v0}, Ll/a/b/k0/k;-><init>(Ll/a/b/d0;)V
    ...
    new-instance v0, Ll/a/b/k0/i;

    invoke-direct {v0}, Ll/a/b/k0/i;-><init>()V
    ...
    new-instance p1, Ll/a/b/k0/j;

    invoke-direct {p1}, Ll/a/b/k0/j;-><init>()V

    return-object p1

    :cond_4
    new-instance p1, Ll/a/b/k0/i;

    invoke-direct {p1}, Ll/a/b/k0/i;-><init>()V
...
.method protected engineDoPhase(Ljava/security/Key;Z)Ljava/security/Key;
    ...
    iget-object v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/edec/KeyAgreementSpi;->agreement:Ll/a/b/d0;
    ...
    invoke-virtual {p1}, Lorg/bouncycastle/jcajce/provider/asymmetric/edec/BCXDHPublicKey;->engineGetKeyParameters()Ll/a/b/u0/b;

    move-result-object p1

    iget-object p2, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/edec/KeyAgreementSpi;->agreement:Ll/a/b/d0;

    invoke-interface {p2}, Ll/a/b/d0;->b()I
    ...
    iget-object v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/edec/KeyAgreementSpi;->dhuSpec:Ll/a/c/v/e;
    ...
    new-instance v2, Ll/a/b/u0/x1;

    invoke-virtual {v0}, Ll/a/c/v/e;->c()Ljava/security/PublicKey;

    move-result-object v0

    check-cast v0, Lorg/bouncycastle/jcajce/provider/asymmetric/edec/BCXDHPublicKey;

    invoke-virtual {v0}, Lorg/bouncycastle/jcajce/provider/asymmetric/edec/BCXDHPublicKey;->engineGetKeyParameters()Ll/a/b/u0/b;

    move-result-object v0

    invoke-direct {v2, p1, v0}, Ll/a/b/u0/x1;-><init>(Ll/a/b/u0/b;Ll/a/b/u0/b;)V

    iget-object p1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/edec/KeyAgreementSpi;->result:[B

    invoke-interface {p2, v2, p1, v1}, Ll/a/b/d0;->a(Ll/a/b/i;[BI)V
    ...
    invoke-interface {v0, p1, p2, v1}, Ll/a/b/d0;->a(Ll/a/b/i;[BI)V
...
.method protected engineInit(Ljava/security/Key;Ljava/security/SecureRandom;)V
    ...
    invoke-virtual {p1}, Lorg/bouncycastle/jcajce/provider/asymmetric/edec/BCXDHPrivateKey;->engineGetKeyParameters()Ll/a/b/u0/b;

    move-result-object p1

    instance-of p2, p1, Ll/a/b/u0/u1;
    ...
    :goto_0
    invoke-direct {p0, p2}, Lorg/bouncycastle/jcajce/provider/asymmetric/edec/KeyAgreementSpi;->getAgreement(Ljava/lang/String;)Ll/a/b/d0;

    move-result-object p2

    iput-object p2, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/edec/KeyAgreementSpi;->agreement:Ll/a/b/d0;

    iget-object p2, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/edec/KeyAgreementSpi;->agreement:Ll/a/b/d0;

    invoke-interface {p2, p1}, Ll/a/b/d0;->init(Ll/a/b/i;)V

    iget-object p1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/util/BaseAgreementSpi;->kdf:Ll/a/b/p;
...
.method protected engineInit(Ljava/security/Key;Ljava/security/spec/AlgorithmParameterSpec;Ljava/security/SecureRandom;)V
    ...
    instance-of p3, p1, Ll/a/b/u0/u1;
    ...
    :goto_0
    invoke-direct {p0, p3}, Lorg/bouncycastle/jcajce/provider/asymmetric/edec/KeyAgreementSpi;->getAgreement(Ljava/lang/String;)Ll/a/b/d0;

    move-result-object p3

    iput-object p3, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/edec/KeyAgreementSpi;->agreement:Ll/a/b/d0;
    ...
    iput-object p2, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/edec/KeyAgreementSpi;->dhuSpec:Ll/a/c/v/e;
    ...
    new-instance p3, Ll/a/b/u0/w1;

    iget-object v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/edec/KeyAgreementSpi;->dhuSpec:Ll/a/c/v/e;

    invoke-virtual {v0}, Ll/a/c/v/e;->a()Ljava/security/PrivateKey;

    move-result-object v0

    check-cast v0, Lorg/bouncycastle/jcajce/provider/asymmetric/edec/BCXDHPrivateKey;

    invoke-virtual {v0}, Lorg/bouncycastle/jcajce/provider/asymmetric/edec/BCXDHPrivateKey;->engineGetKeyParameters()Ll/a/b/u0/b;

    move-result-object v0

    iget-object v1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/edec/KeyAgreementSpi;->dhuSpec:Ll/a/c/v/e;

    invoke-virtual {v1}, Ll/a/c/v/e;->b()Ljava/security/PublicKey;

    move-result-object v1

    check-cast v1, Lorg/bouncycastle/jcajce/provider/asymmetric/edec/BCXDHPublicKey;

    invoke-virtual {v1}, Lorg/bouncycastle/jcajce/provider/asymmetric/edec/BCXDHPublicKey;->engineGetKeyParameters()Ll/a/b/u0/b;

    move-result-object v1

    invoke-direct {p3, p1, v0, v1}, Ll/a/b/u0/w1;-><init>(Ll/a/b/u0/b;Ll/a/b/u0/b;Ll/a/b/u0/b;)V

    invoke-interface {p2, p3}, Ll/a/b/d0;->init(Ll/a/b/i;)V
    ...
    :cond_2
    iget-object p3, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/edec/KeyAgreementSpi;->agreement:Ll/a/b/d0;

    invoke-interface {p3, p1}, Ll/a/b/d0;->init(Ll/a/b/i;)V

    instance-of p1, p2, Ll/a/c/v/s;
