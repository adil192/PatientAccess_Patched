...
# direct methods
.method constructor <init>(Ll/a/c/w/c;Ll/a/a/f3/o;)V
    .locals 6
    ...
    invoke-static {p2}, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/X509CRLObject;->createSigAlgName(Ll/a/a/f3/o;)Ljava/lang/String;

    move-result-object v3

    invoke-static {p2}, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/X509CRLObject;->createSigAlgParams(Ll/a/a/f3/o;)[B

    move-result-object v4

    invoke-static {p2}, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/X509CRLObject;->isIndirectCRL(Ll/a/a/f3/o;)Z
    ...
    invoke-direct/range {v0 .. v5}, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/X509CRLImpl;-><init>(Ll/a/c/w/c;Ll/a/a/f3/o;Ljava/lang/String;[BZ)V
...
.method private static createSigAlgName(Ll/a/a/f3/o;)Ljava/lang/String;
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/security/cert/CRLException;
    ...
    :try_start_0
    invoke-virtual {p0}, Ll/a/a/f3/o;->u()Ll/a/a/f3/b;
...
.method private static createSigAlgParams(Ll/a/a/f3/o;)[B
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/security/cert/CRLException;
...
.method private getInternalCRL()Lorg/bouncycastle/jcajce/provider/asymmetric/x509/X509CRLInternal;
    ...
    iget-object v2, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/X509CRLImpl;->bcHelper:Ll/a/c/w/c;
    ...
    invoke-direct/range {v1 .. v7}, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/X509CRLInternal;-><init>(Ll/a/c/w/c;Ll/a/a/f3/o;Ljava/lang/String;[BZ[B)V
...
.method private static isIndirectCRL(Ll/a/a/f3/o;)Z
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/security/cert/CRLException;
    ...
    invoke-static {p0, v0}, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/X509CRLImpl;->getExtensionOctets(Ll/a/a/f3/o;Ljava/lang/String;)[B
...
.method public equals(Ljava/lang/Object;)Z
    ...
    invoke-virtual {v1}, Ll/a/a/f3/o;->s()Ll/a/a/p0;

    move-result-object v1

    if-eqz v1, :cond_3

    iget-object v0, v0, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/X509CRLImpl;->c:Ll/a/a/f3/o;
