...
# instance fields
.field engine:Ll/a/b/p0/d;

.field initialised:Z

.field param:Ll/a/b/u0/e;
...
.method public constructor <init>()V
    ...
    new-instance v0, Ll/a/b/p0/d;

    invoke-direct {v0}, Ll/a/b/p0/d;-><init>()V

    iput-object v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/dh/KeyPairGeneratorSpi;->engine:Ll/a/b/p0/d;
...
.method private convertParams(Ljava/security/SecureRandom;Ljavax/crypto/spec/DHParameterSpec;)Ll/a/b/u0/e;
    .locals 5
    ...
    invoke-direct {v0, p1, p2}, Ll/a/b/u0/e;-><init>(Ljava/security/SecureRandom;Ll/a/b/u0/i;)V
    ...
    invoke-direct {v1, v2, v3, v4, p2}, Ll/a/b/u0/i;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;I)V

    invoke-direct {v0, p1, v1}, Ll/a/b/u0/e;-><init>(Ljava/security/SecureRandom;Ll/a/b/u0/i;)V
...
.method public generateKeyPair()Ljava/security/KeyPair;
    ...
    check-cast v0, Ll/a/b/u0/e;

    :goto_0
    iput-object v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/dh/KeyPairGeneratorSpi;->param:Ll/a/b/u0/e;
    ...
    invoke-direct {p0, v0, v1}, Lorg/bouncycastle/jcajce/provider/asymmetric/dh/KeyPairGeneratorSpi;->convertParams(Ljava/security/SecureRandom;Ljavax/crypto/spec/DHParameterSpec;)Ll/a/b/u0/e;
    ...
    :cond_2
    new-instance v2, Ll/a/b/p0/g;

    invoke-direct {v2}, Ll/a/b/p0/g;-><init>()V
    ...
    invoke-virtual {v2, v3, v4, v5}, Ll/a/b/p0/g;->b(IILjava/security/SecureRandom;)V

    new-instance v3, Ll/a/b/u0/e;

    iget-object v4, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/dh/KeyPairGeneratorSpi;->random:Ljava/security/SecureRandom;

    invoke-virtual {v2}, Ll/a/b/p0/g;->a()Ll/a/b/u0/i;

    move-result-object v2

    invoke-direct {v3, v4, v2}, Ll/a/b/u0/e;-><init>(Ljava/security/SecureRandom;Ll/a/b/u0/i;)V

    iput-object v3, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/dh/KeyPairGeneratorSpi;->param:Ll/a/b/u0/e;
    ...
    :goto_2
    iget-object v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/dh/KeyPairGeneratorSpi;->engine:Ll/a/b/p0/d;

    iget-object v1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/dh/KeyPairGeneratorSpi;->param:Ll/a/b/u0/e;

    invoke-virtual {v0, v1}, Ll/a/b/p0/d;->a(Ll/a/b/w;)V
    ...
    invoke-virtual {v0}, Ll/a/b/p0/d;->b()Ll/a/b/b;
    ...
    check-cast v1, Ll/a/b/u0/k;

    invoke-virtual {v0}, Ll/a/b/b;->a()Ll/a/b/u0/b;

    move-result-object v0

    check-cast v0, Ll/a/b/u0/j;

    new-instance v2, Ljava/security/KeyPair;

    new-instance v3, Lorg/bouncycastle/jcajce/provider/asymmetric/dh/BCDHPublicKey;

    invoke-direct {v3, v1}, Lorg/bouncycastle/jcajce/provider/asymmetric/dh/BCDHPublicKey;-><init>(Ll/a/b/u0/k;)V

    new-instance v1, Lorg/bouncycastle/jcajce/provider/asymmetric/dh/BCDHPrivateKey;

    invoke-direct {v1, v0}, Lorg/bouncycastle/jcajce/provider/asymmetric/dh/BCDHPrivateKey;-><init>(Ll/a/b/u0/j;)V
...
.method public initialize(Ljava/security/spec/AlgorithmParameterSpec;Ljava/security/SecureRandom;)V
    ...
    :try_start_0
    invoke-direct {p0, p2, p1}, Lorg/bouncycastle/jcajce/provider/asymmetric/dh/KeyPairGeneratorSpi;->convertParams(Ljava/security/SecureRandom;Ljavax/crypto/spec/DHParameterSpec;)Ll/a/b/u0/e;

    move-result-object p1

    iput-object p1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/dh/KeyPairGeneratorSpi;->param:Ll/a/b/u0/e;
    :try_end_0
    .catch Ljava/lang/IllegalArgumentException; {:try_start_0 .. :try_end_0} :catch_0

    iget-object p2, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/dh/KeyPairGeneratorSpi;->engine:Ll/a/b/p0/d;

    invoke-virtual {p2, p1}, Ll/a/b/p0/d;->a(Ll/a/b/w;)V
