...
.field engine:Ll/a/b/p0/l;

.field initialised:Z

.field param:Ll/a/b/u0/a0;
...
.method public constructor <init>()V
    ...
    new-instance v1, Ll/a/b/p0/l;

    invoke-direct {v1}, Ll/a/b/p0/l;-><init>()V

    iput-object v1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/ec/KeyPairGeneratorSpi$EC;->engine:Ll/a/b/p0/l;
...
.method public constructor <init>(Ljava/lang/String;Lorg/bouncycastle/jcajce/provider/config/ProviderConfiguration;)V
    ...
    iput-object v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/ec/KeyPairGeneratorSpi$EC;->engine:Ll/a/b/p0/l;
...
# virtual methods
.method protected createKeyGenParamsBC(Ll/a/d/h/e;Ljava/security/SecureRandom;)Ll/a/b/u0/a0;
    .locals 5

    new-instance v0, Ll/a/b/u0/a0;

    new-instance v1, Ll/a/b/u0/y;
    ...
    invoke-direct {v1, v2, v3, v4, p1}, Ll/a/b/u0/y;-><init>(Ll/a/e/b/e;Ll/a/e/b/i;Ljava/math/BigInteger;Ljava/math/BigInteger;)V

    invoke-direct {v0, v1, p2}, Ll/a/b/u0/a0;-><init>(Ll/a/b/u0/y;Ljava/security/SecureRandom;)V

    return-object v0
.end method

.method protected createKeyGenParamsJCE(Ljava/security/spec/ECParameterSpec;Ljava/security/SecureRandom;)Ll/a/b/u0/a0;
    .locals 5

    instance-of v0, p1, Ll/a/d/h/d;
    ...
    invoke-static {v0}, Lorg/bouncycastle/jcajce/provider/asymmetric/ec/ECUtils;->getDomainParametersFromName(Ljava/lang/String;)Ll/a/a/g3/i;
    ...
    invoke-direct {p1, v1, v2, v3, v0}, Ll/a/b/u0/y;-><init>(Ll/a/e/b/e;Ll/a/e/b/i;Ljava/math/BigInteger;Ljava/math/BigInteger;)V

    new-instance v0, Ll/a/b/u0/a0;

    invoke-direct {v0, p1, p2}, Ll/a/b/u0/a0;-><init>(Ll/a/b/u0/y;Ljava/security/SecureRandom;)V
    ...
    new-instance v3, Ll/a/b/u0/y;

    invoke-direct {v3, v0, v1, v2, p1}, Ll/a/b/u0/y;-><init>(Ll/a/e/b/e;Ll/a/e/b/i;Ljava/math/BigInteger;Ljava/math/BigInteger;)V

    new-instance p1, Ll/a/b/u0/a0;

    invoke-direct {p1, v3, p2}, Ll/a/b/u0/a0;-><init>(Ll/a/b/u0/y;Ljava/security/SecureRandom;)V

    return-object p1
.end method

.method protected createNamedCurveSpec(Ljava/lang/String;)Ll/a/d/h/d;
    .locals 9
    ...
    invoke-static {p1}, Lorg/bouncycastle/jcajce/provider/asymmetric/ec/ECUtils;->getDomainParametersFromName(Ljava/lang/String;)Ll/a/a/g3/i;
    ...
    invoke-direct/range {v1 .. v7}, Ll/a/d/h/d;-><init>(Ljava/lang/String;Ll/a/e/b/e;Ll/a/e/b/i;Ljava/math/BigInteger;Ljava/math/BigInteger;[B)V
...
.method public generateKeyPair()Ljava/security/KeyPair;
    ...
    :cond_0
    iget-object v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/ec/KeyPairGeneratorSpi$EC;->engine:Ll/a/b/p0/l;

    invoke-virtual {v0}, Ll/a/b/p0/l;->b()Ll/a/b/b;
    ...
    invoke-direct {v0, v2, v1, v6, v3}, Lorg/bouncycastle/jcajce/provider/asymmetric/ec/BCECPublicKey;-><init>(Ljava/lang/String;Ll/a/b/u0/e0;Ll/a/d/h/e;Lorg/bouncycastle/jcajce/provider/config/ProviderConfiguration;)V
    ...
    invoke-direct/range {v2 .. v7}, Lorg/bouncycastle/jcajce/provider/asymmetric/ec/BCECPrivateKey;-><init>(Ljava/lang/String;Ll/a/b/u0/d0;Lorg/bouncycastle/jcajce/provider/asymmetric/ec/BCECPublicKey;Ll/a/d/h/e;Lorg/bouncycastle/jcajce/provider/config/ProviderConfiguration;)V
    ...
    invoke-direct {v2, v3, v1, v5}, Lorg/bouncycastle/jcajce/provider/asymmetric/ec/BCECPublicKey;-><init>(Ljava/lang/String;Ll/a/b/u0/e0;Lorg/bouncycastle/jcajce/provider/config/ProviderConfiguration;)V
    ...
    invoke-direct {v1, v3, v4, v5}, Lorg/bouncycastle/jcajce/provider/asymmetric/ec/BCECPrivateKey;-><init>(Ljava/lang/String;Ll/a/b/u0/d0;Lorg/bouncycastle/jcajce/provider/config/ProviderConfiguration;)V
    ...
    invoke-direct {v0, v2, v1, v6, v3}, Lorg/bouncycastle/jcajce/provider/asymmetric/ec/BCECPublicKey;-><init>(Ljava/lang/String;Ll/a/b/u0/e0;Ljava/security/spec/ECParameterSpec;Lorg/bouncycastle/jcajce/provider/config/ProviderConfiguration;)V
    ...
    invoke-direct/range {v2 .. v7}, Lorg/bouncycastle/jcajce/provider/asymmetric/ec/BCECPrivateKey;-><init>(Ljava/lang/String;Ll/a/b/u0/d0;Lorg/bouncycastle/jcajce/provider/asymmetric/ec/BCECPublicKey;Ljava/security/spec/ECParameterSpec;Lorg/bouncycastle/jcajce/provider/config/ProviderConfiguration;)V
...
.method public initialize(Ljava/security/spec/AlgorithmParameterSpec;Ljava/security/SecureRandom;)V
    ...
    :goto_0
    invoke-virtual {p0, p1, p2}, Lorg/bouncycastle/jcajce/provider/asymmetric/ec/KeyPairGeneratorSpi$EC;->createKeyGenParamsBC(Ll/a/d/h/e;Ljava/security/SecureRandom;)Ll/a/b/u0/a0;

    move-result-object p1

    :goto_1
    iput-object p1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/ec/KeyPairGeneratorSpi$EC;->param:Ll/a/b/u0/a0;
    ...
    invoke-virtual {p0, p1, p2}, Lorg/bouncycastle/jcajce/provider/asymmetric/ec/KeyPairGeneratorSpi$EC;->createKeyGenParamsJCE(Ljava/security/spec/ECParameterSpec;Ljava/security/SecureRandom;)Ll/a/b/u0/a0;
    ...
    :cond_4
    instance-of v0, p1, Ll/a/d/h/b;

    if-eqz v0, :cond_5

    check-cast p1, Ll/a/d/h/b;

    invoke-virtual {p1}, Ll/a/d/h/b;->a()Ljava/lang/String;
    ...
    :goto_3
    iget-object p1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/ec/KeyPairGeneratorSpi$EC;->engine:Ll/a/b/p0/l;

    iget-object p2, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/ec/KeyPairGeneratorSpi$EC;->param:Ll/a/b/u0/a0;

    invoke-virtual {p1, p2}, Ll/a/b/p0/l;->a(Ll/a/b/w;)V
...
.method protected initializeNamedCurve(Ljava/lang/String;Ljava/security/SecureRandom;)V
    ...
    invoke-virtual {p0, p1}, Lorg/bouncycastle/jcajce/provider/asymmetric/ec/KeyPairGeneratorSpi$EC;->createNamedCurveSpec(Ljava/lang/String;)Ll/a/d/h/d;
