...
.field protected wrapEngine:Ll/a/b/i0;
...
.method protected constructor <init>()V
    ...
    iput-object v0, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseWrapCipher;->wrapEngine:Ll/a/b/i0;
    ...
    iput-object v0, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseWrapCipher;->helper:Ll/a/c/w/c;

    return-void
.end method

.method protected constructor <init>(Ll/a/b/i0;)V
    .locals 1

    const/4 v0, 0x0

    invoke-direct {p0, p1, v0}, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseWrapCipher;-><init>(Ll/a/b/i0;I)V

    return-void
.end method

.method protected constructor <init>(Ll/a/b/i0;I)V
    .locals 5
    ...
    iput-object p1, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseWrapCipher;->wrapEngine:Ll/a/b/i0;
...
.method protected final createParametersInstance(Ljava/lang/String;)Ljava/security/AlgorithmParameters;
    ...
    iget-object v0, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseWrapCipher;->helper:Ll/a/c/w/c;
...
.method protected engineDoFinal([BII[BI)I
    ...
    :try_start_1
    iget-object p1, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseWrapCipher;->wrapEngine:Ll/a/b/i0;
    ...
    invoke-interface {p1, p3, p2, v0}, Ll/a/b/i0;->b([BII)[B
    ...
    invoke-interface {p1, p3, p2, v0}, Ll/a/b/i0;->a([BII)[B

    move-result-object p1
    :try_end_3
    .catch Ll/a/b/u; {:try_start_3 .. :try_end_3} :catch_1
...
.method protected engineGetParameters()Ljava/security/AlgorithmParameters;
    ...
    iget-object v0, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseWrapCipher;->wrapEngine:Ll/a/b/i0;

    invoke-interface {v0}, Ll/a/b/i0;->getAlgorithmName()Ljava/lang/String;
...
.method protected engineInit(ILjava/security/Key;Ljava/security/spec/AlgorithmParameterSpec;Ljava/security/SecureRandom;)V
    ...
    invoke-direct {v0, p2}, Ll/a/b/u0/a1;-><init>([B)V
    ...
    invoke-direct {v1, p2, v0}, Ll/a/b/u0/e1;-><init>(Ll/a/b/i;[B)V

    move-object p2, v1

    :cond_3
    instance-of v0, p3, Ll/a/c/v/i;

    if-eqz v0, :cond_5

    check-cast p3, Ll/a/c/v/i;

    invoke-virtual {p3}, Ll/a/c/v/i;->a()[B
    ...
    invoke-direct {v1, p2, v0}, Ll/a/b/u0/g1;-><init>(Ll/a/b/i;[B)V
    ...
    invoke-virtual {p3}, Ll/a/c/v/i;->b()[B

    move-result-object p3

    invoke-direct {v0, p2, p3}, Ll/a/b/u0/h1;-><init>(Ll/a/b/i;[B)V

    move-object p2, v0

    :cond_5
    instance-of p3, p2, Ll/a/b/u0/a1;
    ...
    invoke-direct {p3, p2, v2}, Ll/a/b/u0/e1;-><init>(Ll/a/b/i;[B)V
    ...
    new-instance p3, Ll/a/b/u0/f1;

    invoke-direct {p3, p2, p4}, Ll/a/b/u0/f1;-><init>(Ll/a/b/i;Ljava/security/SecureRandom;)V
    ...
    invoke-interface {p1, p4, p2}, Ll/a/b/i0;->init(ZLl/a/b/i;)V
    ...
    invoke-interface {p1, v1, p2}, Ll/a/b/i0;->init(ZLl/a/b/i;)V
...
.method protected engineUnwrap([BLjava/lang/String;I)Ljava/security/Key;
    ...
    :try_start_0
    iget-object v1, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseWrapCipher;->wrapEngine:Ll/a/b/i0;
    ...
    invoke-interface {v1, p1, v2, v3}, Ll/a/b/i0;->a([BII)[B

    move-result-object p1
    :try_end_0
    .catch Ll/a/b/u; {:try_start_0 .. :try_end_0} :catch_5
    ...
    invoke-static {p1}, Lorg/bouncycastle/jce/provider/BouncyCastleProvider;->getPrivateKey(Ll/a/a/y2/p;)Ljava/security/PrivateKey;
    ...
    :cond_3
    :try_start_2
    iget-object v1, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseWrapCipher;->helper:Ll/a/c/w/c;

    invoke-interface {v1, p2}, Ll/a/c/w/c;->h(Ljava/lang/String;)Ljava/security/KeyFactory;
...
.method protected engineWrap(Ljava/security/Key;)[B
    ...
    invoke-interface {v0, p1, v1, v2}, Ll/a/b/i0;->b([BII)[B
