...
.field private macEngine:Ll/a/b/y;
...
.method protected constructor <init>(Ll/a/b/y;)V
    .locals 1
    ...
    iput-object p1, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseMac;->macEngine:Ll/a/b/y;

    return-void
.end method

.method protected constructor <init>(Ll/a/b/y;III)V
    .locals 1
...
.method protected engineDoFinal()[B
    ...
    iget-object v1, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseMac;->macEngine:Ll/a/b/y;
...
.method protected engineGetMacLength()I
    ...
    iget-object v0, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseMac;->macEngine:Ll/a/b/y;
...
.method protected engineInit(Ljava/security/Key;Ljava/security/spec/AlgorithmParameterSpec;)V
    ...
    iget-object v3, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseMac;->macEngine:Ll/a/b/y;

    invoke-interface {v3}, Ll/a/b/y;->getAlgorithmName()Ljava/lang/String;
    ...
    iget-object v2, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseMac;->macEngine:Ll/a/b/y;

    invoke-interface {v2}, Ll/a/b/y;->getAlgorithmName()Ljava/lang/String;
    ...
    invoke-interface {v0}, Ll/a/b/y;->getAlgorithmName()Ljava/lang/String;
    ...
    :goto_1
    invoke-static {v0, v4, v2, v5, v1}, Lorg/bouncycastle/jcajce/provider/symmetric/util/PBE$Util;->makePBEMacParameters(Ljavax/crypto/SecretKey;IIILjavax/crypto/spec/PBEParameterSpec;)Ll/a/b/i;
    ...
    invoke-virtual {v0}, Lorg/bouncycastle/jcajce/provider/symmetric/util/BCPBEKey;->getParam()Ll/a/b/i;
    ...
    invoke-static {v0, p2}, Lorg/bouncycastle/jcajce/provider/symmetric/util/PBE$Util;->makePBEMacParameters(Lorg/bouncycastle/jcajce/provider/symmetric/util/BCPBEKey;Ljava/security/spec/AlgorithmParameterSpec;)Ll/a/b/i;
    ...
    invoke-direct {v0, v1}, Ll/a/b/u0/a1;-><init>([B)V
    ...
    check-cast v1, Ll/a/b/u0/e1;

    invoke-virtual {v1}, Ll/a/b/u0/e1;->b()Ll/a/b/i;
    ...
    :goto_3
    instance-of v2, p2, Ll/a/c/v/a;

    if-eqz v2, :cond_d

    check-cast p2, Ll/a/c/v/a;

    new-instance v0, Ll/a/b/u0/a;

    invoke-virtual {p2}, Ll/a/c/v/a;->b()I

    move-result p1

    invoke-virtual {p2}, Ll/a/c/v/a;->c()[B

    move-result-object v2

    invoke-virtual {p2}, Ll/a/c/v/a;->a()[B

    move-result-object p2

    invoke-direct {v0, v1, p1, v2, p2}, Ll/a/b/u0/a;-><init>(Ll/a/b/u0/a1;I[B[B)V
    ...
    invoke-direct {v0, v1, p1}, Ll/a/b/u0/e1;-><init>(Ll/a/b/i;[B)V
    ...
    new-instance p1, Ll/a/b/u0/i1;

    invoke-virtual {v1}, Ll/a/b/u0/a1;->a()[B
    ...
    invoke-direct {p1, v1, v2}, Ll/a/b/u0/i1;-><init>([BI)V

    invoke-virtual {p2}, Ljavax/crypto/spec/RC2ParameterSpec;->getIV()[B

    move-result-object p2

    invoke-direct {v0, p1, p2}, Ll/a/b/u0/e1;-><init>(Ll/a/b/i;[B)V

    goto :goto_4

    :cond_f
    instance-of v2, p2, Ll/a/c/v/q;

    if-eqz v2, :cond_10

    new-instance p1, Ll/a/b/u0/o1$b;

    check-cast p2, Ll/a/c/v/q;

    invoke-virtual {p2}, Ll/a/c/v/q;->a()Ljava/util/Map;
    ...
    invoke-direct {p1, p2}, Ll/a/b/u0/o1$b;-><init>(Ljava/util/Hashtable;)V

    invoke-virtual {v1}, Ll/a/b/u0/a1;->a()[B

    move-result-object p2

    invoke-virtual {p1, p2}, Ll/a/b/u0/o1$b;->c([B)Ll/a/b/u0/o1$b;
    ...
    invoke-static {v1, p2}, Lorg/bouncycastle/jcajce/provider/symmetric/util/GcmSpecUtil;->extractAeadParameters(Ll/a/b/u0/a1;Ljava/security/spec/AlgorithmParameterSpec;)Ll/a/b/u0/a;
    ...
    :goto_4
    :try_start_2
    iget-object p1, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseMac;->macEngine:Ll/a/b/y;

    invoke-interface {p1, v0}, Ll/a/b/y;->init(Ll/a/b/i;)V
    :try_end_2
