...
# instance fields
.field private aeadParams:Ll/a/b/u0/a;

.field private availableSpecs:[Ljava/lang/Class;

.field private baseEngine:Ll/a/b/e;
...
.field private ivParam:Ll/a/b/u0/e1;
...
.method protected constructor <init>(Ll/a/b/e;)V
    .locals 5
    ...
    iput-object p1, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseBlockCipher;->baseEngine:Ll/a/b/e;

    new-instance v0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseBlockCipher$BufferedGenericBlockCipher;

    invoke-direct {v0, p1}, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseBlockCipher$BufferedGenericBlockCipher;-><init>(Ll/a/b/e;)V
...
.method protected constructor <init>(Ll/a/b/e;I)V
    .locals 1

    const/4 v0, 0x1

    invoke-direct {p0, p1, v0, p2}, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseBlockCipher;-><init>(Ll/a/b/e;ZI)V

    return-void
.end method

.method protected constructor <init>(Ll/a/b/e;IIII)V
    .locals 5
    ...
    invoke-direct {p2, p1}, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseBlockCipher$BufferedGenericBlockCipher;-><init>(Ll/a/b/e;)V
...
.method protected constructor <init>(Ll/a/b/e;ZI)V
    .locals 5
...
.method protected constructor <init>(Ll/a/b/f;I)V
    .locals 1

    const/4 v0, 0x1

    invoke-direct {p0, p1, v0, p2}, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseBlockCipher;-><init>(Ll/a/b/f;ZI)V

    return-void
.end method

.method protected constructor <init>(Ll/a/b/f;ZI)V
    .locals 5
    ...
    invoke-virtual {p1}, Ll/a/b/f;->d()Ll/a/b/e;

    move-result-object v0

    iput-object v0, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseBlockCipher;->baseEngine:Ll/a/b/e;

    new-instance v0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseBlockCipher$BufferedGenericBlockCipher;

    invoke-direct {v0, p1}, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseBlockCipher$BufferedGenericBlockCipher;-><init>(Ll/a/b/f;)V
...
.method protected constructor <init>(Ll/a/b/s0/a;)V
    .locals 5
    ...
    invoke-interface {p1}, Ll/a/b/s0/a;->getUnderlyingCipher()Ll/a/b/e;
    ...
    invoke-direct {v0, p1}, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseBlockCipher$AEADGenericBlockCipher;-><init>(Ll/a/b/s0/b;)V
...
.method protected constructor <init>(Ll/a/b/s0/a;ZI)V
    .locals 5
    ...
    invoke-direct {p2, p1}, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseBlockCipher$AEADGenericBlockCipher;-><init>(Ll/a/b/s0/b;)V
...
.method protected constructor <init>(Ll/a/b/s0/b;ZI)V
    .locals 5
...
.method protected constructor <init>(Lorg/bouncycastle/jcajce/provider/symmetric/util/BlockCipherProvider;)V
    ...
    invoke-interface {p1}, Lorg/bouncycastle/jcajce/provider/symmetric/util/BlockCipherProvider;->get()Ll/a/b/e;
...
.method private adjustParameters(Ljava/security/spec/AlgorithmParameterSpec;Ll/a/b/i;)Ll/a/b/i;
    .locals 3

    instance-of v0, p2, Ll/a/b/u0/e1;
    ...
    new-instance p2, Ll/a/b/u0/e1;

    invoke-virtual {p1}, Ljavax/crypto/spec/IvParameterSpec;->getIV()[B

    move-result-object p1

    invoke-direct {p2, v0, p1}, Ll/a/b/u0/e1;-><init>(Ll/a/b/i;[B)V

    :goto_0
    iput-object p2, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseBlockCipher;->ivParam:Ll/a/b/u0/e1;

    goto :goto_1

    :cond_0
    instance-of v1, p1, Ll/a/c/v/h;

    if-eqz v1, :cond_5

    check-cast p1, Ll/a/c/v/h;

    new-instance v1, Ll/a/b/u0/g1;

    invoke-virtual {p1}, Ll/a/c/v/h;->d()[B

    move-result-object v2

    invoke-direct {v1, p2, v2}, Ll/a/b/u0/g1;-><init>(Ll/a/b/i;[B)V

    invoke-virtual {p1}, Ll/a/c/v/h;->a()[B
    ...
    invoke-direct {v0, p2, p1}, Ll/a/b/u0/e1;-><init>(Ll/a/b/i;[B)V

    iput-object v0, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseBlockCipher;->ivParam:Ll/a/b/u0/e1;
    ...
    :cond_4
    instance-of v0, p1, Ll/a/c/v/h;

    if-eqz v0, :cond_5

    check-cast p1, Ll/a/c/v/h;

    new-instance v0, Ll/a/b/u0/g1;

    invoke-virtual {p1}, Ll/a/c/v/h;->d()[B

    move-result-object v1

    invoke-direct {v0, p2, v1}, Ll/a/b/u0/g1;-><init>(Ll/a/b/i;[B)V
...
.method protected engineDoFinal([BII[BI)I
    ...
    move-result p2
    :try_end_0
    .catch Ll/a/b/a0; {:try_start_0 .. :try_end_0} :catch_1
    .catch Ll/a/b/o; {:try_start_0 .. :try_end_0} :catch_0
...
.method protected engineGetBlockSize()I
    ...
    iget-object v0, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseBlockCipher;->baseEngine:Ll/a/b/e;
...
.method protected engineGetIV()[B
    ...
    iget-object v0, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseBlockCipher;->aeadParams:Ll/a/b/u0/a;

    if-eqz v0, :cond_0

    invoke-virtual {v0}, Ll/a/b/u0/a;->d()[B
    ...
    :cond_0
    iget-object v0, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseBlockCipher;->ivParam:Ll/a/b/u0/e1;

    if-eqz v0, :cond_1

    invoke-virtual {v0}, Ll/a/b/u0/e1;->a()[B
...
.method protected engineGetParameters()Ljava/security/AlgorithmParameters;
    ...
    :try_start_1
    sget-object v0, Ll/a/a/y2/n;->P0:Ll/a/a/o;
    ...
    iget-object v2, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseBlockCipher;->aeadParams:Ll/a/b/u0/a;

    invoke-virtual {v2}, Ll/a/b/u0/a;->d()[B
    ...
    iget-object v3, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseBlockCipher;->aeadParams:Ll/a/b/u0/a;

    invoke-virtual {v3}, Ll/a/b/u0/a;->c()I

    move-result v3

    div-int/lit8 v3, v3, 0x8

    invoke-direct {v1, v2, v3}, Ll/a/a/g2/b;-><init>([BI)V
    ...
    invoke-interface {v0}, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseBlockCipher$GenericBlockCipher;->getUnderlyingCipher()Ll/a/b/e;
    ...
    iget-object v2, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseBlockCipher;->ivParam:Ll/a/b/u0/e1;

    invoke-virtual {v2}, Ll/a/b/u0/e1;->a()[B
...
.method protected engineInit(ILjava/security/Key;Ljava/security/spec/AlgorithmParameterSpec;Ljava/security/SecureRandom;)V
    ...
    iput-object v5, v1, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseBlockCipher;->aeadParams:Ll/a/b/u0/a;
    ...
    iget-object v6, v1, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseBlockCipher;->baseEngine:Ll/a/b/e;

    if-eqz v6, :cond_3

    invoke-interface {v6}, Ll/a/b/e;->getAlgorithmName()Ljava/lang/String;
    ...
    :cond_4
    instance-of v11, v2, Ll/a/c/f;

    if-eqz v11, :cond_7

    move-object v6, v2

    check-cast v6, Ll/a/c/f;
    ...
    check-cast v11, Ll/a/c/g;

    invoke-virtual {v11}, Ll/a/c/g;->getSalt()[B

    move-result-object v12

    invoke-virtual {v11}, Ll/a/c/g;->getIterationCount()I
    ...
    :cond_6
    invoke-virtual {v6}, Ll/a/c/f;->getEncoded()[B
    ...
    invoke-static/range {v13 .. v19}, Lorg/bouncycastle/jcajce/provider/symmetric/util/PBE$Util;->makePBEParameters([BIIIILjava/security/spec/AlgorithmParameterSpec;Ljava/lang/String;)Ll/a/b/i;

    move-result-object v6

    instance-of v8, v6, Ll/a/b/u0/e1;
    ...
    check-cast v8, Ll/a/b/u0/e1;

    iput-object v8, v1, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseBlockCipher;->ivParam:Ll/a/b/u0/e1;
    ...
    invoke-virtual {v6}, Lorg/bouncycastle/jcajce/provider/symmetric/util/BCPBEKey;->getOID()Ll/a/a/o;
    ...
    invoke-virtual {v6}, Lorg/bouncycastle/jcajce/provider/symmetric/util/BCPBEKey;->getParam()Ll/a/b/i;
    ...
    invoke-direct {v1, v3, v6}, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseBlockCipher;->adjustParameters(Ljava/security/spec/AlgorithmParameterSpec;Ll/a/b/i;)Ll/a/b/i;
    ...
    invoke-interface {v8}, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseBlockCipher$GenericBlockCipher;->getUnderlyingCipher()Ll/a/b/e;

    move-result-object v8

    invoke-interface {v8}, Ll/a/b/e;->getAlgorithmName()Ljava/lang/String;

    move-result-object v8

    invoke-static {v6, v3, v8}, Lorg/bouncycastle/jcajce/provider/symmetric/util/PBE$Util;->makePBEParameters(Lorg/bouncycastle/jcajce/provider/symmetric/util/BCPBEKey;Ljava/security/spec/AlgorithmParameterSpec;Ljava/lang/String;)Ll/a/b/i;
    ...
    invoke-direct {v6, v8}, Ll/a/b/u0/a1;-><init>([B)V
    ...
    invoke-virtual {v8}, Lorg/bouncycastle/jcajce/provider/symmetric/util/BCPBEKey;->getParam()Ll/a/b/i;

    move-result-object v8

    instance-of v11, v8, Ll/a/b/u0/e1;
    ...
    invoke-static/range {v12 .. v18}, Lorg/bouncycastle/jcajce/provider/symmetric/util/PBE$Util;->makePBEParameters([BIIIILjava/security/spec/AlgorithmParameterSpec;Ljava/lang/String;)Ll/a/b/i;
    ...
    invoke-static/range {v11 .. v17}, Lorg/bouncycastle/jcajce/provider/symmetric/util/PBE$Util;->makePBEParameters([BIIIILjava/security/spec/AlgorithmParameterSpec;Ljava/lang/String;)Ll/a/b/i;
    ...
    check-cast v2, Ll/a/c/v/a;

    instance-of v3, v6, Ll/a/b/u0/e1;

    if-eqz v3, :cond_1b

    check-cast v6, Ll/a/b/u0/e1;

    invoke-virtual {v6}, Ll/a/b/u0/e1;->b()Ll/a/b/i;

    move-result-object v3

    check-cast v3, Ll/a/b/u0/a1;
    ...
    :goto_b
    new-instance v6, Ll/a/b/u0/a;

    invoke-virtual {v2}, Ll/a/c/v/a;->b()I

    move-result v5

    invoke-virtual {v2}, Ll/a/c/v/a;->c()[B

    move-result-object v8

    invoke-virtual {v2}, Ll/a/c/v/a;->a()[B

    move-result-object v2

    invoke-direct {v6, v3, v5, v8, v2}, Ll/a/b/u0/a;-><init>(Ll/a/b/u0/a1;I[B[B)V

    :goto_c
    iput-object v6, v1, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseBlockCipher;->aeadParams:Ll/a/b/u0/a;
    ...
    invoke-direct {v3, v5, v2}, Ll/a/b/u0/e1;-><init>(Ll/a/b/i;[B)V
    ...
    invoke-direct {v3, v6, v2}, Ll/a/b/u0/e1;-><init>(Ll/a/b/i;[B)V

    :goto_e
    move-object v6, v3

    iput-object v6, v1, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseBlockCipher;->ivParam:Ll/a/b/u0/e1;
    ...
    :cond_22
    instance-of v8, v3, Ll/a/c/v/h;

    if-eqz v8, :cond_25

    check-cast v3, Ll/a/c/v/h;

    new-instance v5, Ll/a/b/u0/g1;
    ...
    invoke-virtual {v3}, Ll/a/c/v/h;->d()[B

    move-result-object v2

    invoke-direct {v5, v6, v2}, Ll/a/b/u0/g1;-><init>(Ll/a/b/i;[B)V

    invoke-virtual {v3}, Ll/a/c/v/h;->a()[B
    ...
    instance-of v2, v5, Ll/a/b/u0/e1;

    if-eqz v2, :cond_23

    new-instance v2, Ll/a/b/u0/e1;

    check-cast v5, Ll/a/b/u0/e1;

    invoke-virtual {v5}, Ll/a/b/u0/e1;->b()Ll/a/b/i;
    ...
    invoke-direct {v2, v5, v3}, Ll/a/b/u0/e1;-><init>(Ll/a/b/i;[B)V
    ...
    :goto_f
    iput-object v2, v1, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseBlockCipher;->ivParam:Ll/a/b/u0/e1;
    ...
    invoke-direct {v5, v2, v6}, Ll/a/b/u0/i1;-><init>([BI)V
    ...
    invoke-direct {v6, v2, v8}, Ll/a/b/u0/j1;-><init>([BI)V

    iget-object v2, v1, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseBlockCipher;->baseEngine:Ll/a/b/e;

    invoke-interface {v2}, Ll/a/b/e;->getAlgorithmName()Ljava/lang/String;
    ...
    instance-of v2, v6, Ll/a/b/u0/e1;
    ...
    invoke-direct {v2, v6, v3}, Ll/a/b/u0/e1;-><init>(Ll/a/b/i;[B)V
    ...
    :goto_12
    invoke-static {v2, v3}, Lorg/bouncycastle/jcajce/provider/symmetric/util/GcmSpecUtil;->extractAeadParameters(Ll/a/b/u0/a1;Ljava/security/spec/AlgorithmParameterSpec;)Ll/a/b/u0/a;
    ...
    invoke-interface {v2}, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseBlockCipher$GenericBlockCipher;->getUnderlyingCipher()Ll/a/b/e;
    ...
    invoke-direct {v2, v6, v5}, Ll/a/b/u0/e1;-><init>(Ll/a/b/i;[B)V
    ...
    new-instance v2, Ll/a/b/u0/f1;

    invoke-direct {v2, v6, v4}, Ll/a/b/u0/f1;-><init>(Ll/a/b/i;Ljava/security/SecureRandom;)V
    ...
    invoke-interface {v0, v2, v6}, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseBlockCipher$GenericBlockCipher;->init(ZLl/a/b/i;)V
    ...
    invoke-interface {v0, v10, v6}, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseBlockCipher$GenericBlockCipher;->init(ZLl/a/b/i;)V
    ...
    iget-object v2, v1, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseBlockCipher;->aeadParams:Ll/a/b/u0/a;

    if-nez v2, :cond_3e

    check-cast v0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseBlockCipher$AEADGenericBlockCipher;

    invoke-static {v0}, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseBlockCipher$AEADGenericBlockCipher;->access$000(Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseBlockCipher$AEADGenericBlockCipher;)Ll/a/b/s0/b;

    move-result-object v0

    new-instance v2, Ll/a/b/u0/a;

    iget-object v3, v1, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseBlockCipher;->ivParam:Ll/a/b/u0/e1;

    invoke-virtual {v3}, Ll/a/b/u0/e1;->b()Ll/a/b/i;

    move-result-object v3

    check-cast v3, Ll/a/b/u0/a1;

    invoke-interface {v0}, Ll/a/b/s0/b;->a()[B
    ...
    iget-object v4, v1, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseBlockCipher;->ivParam:Ll/a/b/u0/e1;

    invoke-virtual {v4}, Ll/a/b/u0/e1;->a()[B

    move-result-object v4

    invoke-direct {v2, v3, v0, v4}, Ll/a/b/u0/a;-><init>(Ll/a/b/u0/a1;I[B)V

    iput-object v2, v1, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseBlockCipher;->aeadParams:Ll/a/b/u0/a;
    :try_end_1
...
.method protected engineSetMode(Ljava/lang/String;)V
    ...
    invoke-direct {p1, v0}, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseBlockCipher$BufferedGenericBlockCipher;-><init>(Ll/a/b/e;)V
    ...
    iget-object p1, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseBlockCipher;->baseEngine:Ll/a/b/e;
    ...
    iget-object v1, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseBlockCipher;->baseEngine:Ll/a/b/e;
    ...
    iget-object v2, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseBlockCipher;->baseEngine:Ll/a/b/e;

    invoke-direct {v1, v2, p1}, Ll/a/b/s0/u;-><init>(Ll/a/b/e;I)V

    invoke-direct {v0, v1}, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseBlockCipher$BufferedGenericBlockCipher;-><init>(Ll/a/b/e;)V
    ...
    invoke-direct {v0, v1, v2}, Ll/a/b/s0/u;-><init>(Ll/a/b/e;I)V
    ...
    invoke-direct {v1, v2, p1}, Ll/a/b/s0/e;-><init>(Ll/a/b/e;I)V
    ...
    invoke-direct {v0, v1, v2}, Ll/a/b/s0/e;-><init>(Ll/a/b/e;I)V
    ...
    new-instance v1, Ll/a/b/s0/w;

    iget-object v2, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseBlockCipher;->baseEngine:Ll/a/b/e;

    invoke-direct {v1, v2, p1}, Ll/a/b/s0/w;-><init>(Ll/a/b/e;Z)V
    ...
    new-instance v0, Ll/a/b/s0/v;

    iget-object v1, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseBlockCipher;->baseEngine:Ll/a/b/e;

    invoke-direct {v0, v1}, Ll/a/b/s0/v;-><init>(Ll/a/b/e;)V
    ...
    new-instance v1, Ll/a/b/s0/x;

    iget-object v2, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseBlockCipher;->baseEngine:Ll/a/b/e;

    invoke-direct {v1, v2}, Ll/a/b/s0/x;-><init>(Ll/a/b/e;)V

    invoke-direct {v0, v1}, Ll/a/b/f;-><init>(Ll/a/b/e;)V

    invoke-direct {p1, v0}, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseBlockCipher$BufferedGenericBlockCipher;-><init>(Ll/a/b/f;)V
    ...
    instance-of v0, p1, Ll/a/b/o0/r;

    if-eqz v0, :cond_c

    new-instance v0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseBlockCipher$BufferedGenericBlockCipher;

    new-instance v1, Ll/a/b/f;

    new-instance v2, Ll/a/b/s0/r;

    invoke-direct {v2, p1}, Ll/a/b/s0/r;-><init>(Ll/a/b/e;)V

    invoke-direct {v1, v2}, Ll/a/b/f;-><init>(Ll/a/b/e;)V

    invoke-direct {v0, v1}, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseBlockCipher$BufferedGenericBlockCipher;-><init>(Ll/a/b/f;)V
    ...
    new-instance v2, Ll/a/b/s0/x;

    invoke-direct {v2, p1}, Ll/a/b/s0/x;-><init>(Ll/a/b/e;)V
    ...
    new-instance v1, Ll/a/b/s0/o;

    iget-object v2, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseBlockCipher;->baseEngine:Ll/a/b/e;

    invoke-direct {v1, v2}, Ll/a/b/s0/o;-><init>(Ll/a/b/e;)V
    ...
    new-instance v0, Ll/a/b/s0/f;

    new-instance v1, Ll/a/b/s0/c;

    iget-object v2, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseBlockCipher;->baseEngine:Ll/a/b/e;

    invoke-direct {v1, v2}, Ll/a/b/s0/c;-><init>(Ll/a/b/e;)V

    invoke-direct {v0, v1}, Ll/a/b/s0/f;-><init>(Ll/a/b/e;)V
    ...
    invoke-direct {p1, v0}, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseBlockCipher$AEADGenericBlockCipher;-><init>(Ll/a/b/s0/b;)V
    ...
    invoke-interface {v2}, Lorg/bouncycastle/jcajce/provider/symmetric/util/BlockCipherProvider;->get()Ll/a/b/e;

    move-result-object v2

    invoke-direct {v0, v1, v2}, Ll/a/b/s0/t;-><init>(Ll/a/b/e;Ll/a/b/e;)V
    ...
    new-instance v0, Ll/a/b/s0/h;

    iget-object v1, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseBlockCipher;->baseEngine:Ll/a/b/e;

    invoke-direct {v0, v1}, Ll/a/b/s0/h;-><init>(Ll/a/b/e;)V
...
.method protected engineSetPadding(Ljava/lang/String;)V
    ...
    invoke-interface {v1}, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseBlockCipher$GenericBlockCipher;->getUnderlyingCipher()Ll/a/b/e;
    ...
    new-instance v1, Ll/a/b/t0/h;

    invoke-direct {v1}, Ll/a/b/t0/h;-><init>()V

    invoke-direct {p1, v0, v1}, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseBlockCipher$BufferedGenericBlockCipher;-><init>(Ll/a/b/e;Ll/a/b/t0/a;)V
    ...
    new-instance v1, Ll/a/b/t0/f;

    invoke-direct {v1}, Ll/a/b/t0/f;-><init>()V
    ...
    new-instance v1, Ll/a/b/t0/c;

    invoke-direct {v1}, Ll/a/b/t0/c;-><init>()V
    ...
    new-instance v1, Ll/a/b/t0/g;

    invoke-direct {v1}, Ll/a/b/t0/g;-><init>()V
    ...
    new-instance v1, Ll/a/b/t0/b;

    invoke-direct {v1}, Ll/a/b/t0/b;-><init>()V
...
.method protected engineUpdateAAD(Ljava/nio/ByteBuffer;)V
    ...
    invoke-static {v1, v2}, Ll/a/g/a;->w([BB)V
    ...
    invoke-static {v3, v2}, Ll/a/g/a;->w([BB)V
