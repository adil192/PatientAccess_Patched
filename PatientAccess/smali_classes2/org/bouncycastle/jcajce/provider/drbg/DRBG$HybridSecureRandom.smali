...
.field private final drbg:Ll/a/b/w0/f;
...
.method constructor <init>()V
    ...
    invoke-direct {v2, v3}, Ll/a/b/w0/g;-><init>(Ll/a/b/w0/d;)V

    const-string v3, "Bouncy Castle Hybrid Entropy Source"

    invoke-static {v3}, Ll/a/g/p;->f(Ljava/lang/String;)[B

    move-result-object v3

    invoke-virtual {v2, v3}, Ll/a/b/w0/g;->e([B)Ll/a/b/w0/g;

    move-result-object v2

    new-instance v3, Ll/a/b/r0/g;

    new-instance v4, Ll/a/b/l0/a0;

    invoke-direct {v4}, Ll/a/b/l0/a0;-><init>()V
    ...
    invoke-virtual {v2, v3, v0, v1}, Ll/a/b/w0/g;->b(Ll/a/b/y;[BZ)Ll/a/b/w0/f;

    move-result-object v0

    iput-object v0, p0, Lorg/bouncycastle/jcajce/provider/drbg/DRBG$HybridSecureRandom;->drbg:Ll/a/b/w0/f;
...
.method public generateSeed(I)[B
    ...
    iget-object v0, p0, Lorg/bouncycastle/jcajce/provider/drbg/DRBG$HybridSecureRandom;->drbg:Ll/a/b/w0/f;

    const/4 v1, 0x0

    invoke-virtual {v0, v1}, Ll/a/b/w0/f;->a([B)V

    :cond_0
    iget-object v0, p0, Lorg/bouncycastle/jcajce/provider/drbg/DRBG$HybridSecureRandom;->drbg:Ll/a/b/w0/f;

    invoke-virtual {v0, p1}, Ll/a/b/w0/f;->nextBytes([B)V
...
.method public setSeed(J)V
    ...
    invoke-virtual {v0, p1, p2}, Ll/a/b/w0/f;->setSeed(J)V
...
.method public setSeed([B)V
    ...
    invoke-virtual {v0, p1}, Ll/a/b/w0/f;->setSeed([B)V
