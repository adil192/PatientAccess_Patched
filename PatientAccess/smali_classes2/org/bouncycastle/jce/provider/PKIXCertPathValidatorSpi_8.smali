...
.method public constructor <init>(Z)V
    ...
    iput-object v0, p0, Lorg/bouncycastle/jce/provider/PKIXCertPathValidatorSpi_8;->helper:Ll/a/c/w/c;
...
.method static checkCertificate(Ljava/security/cert/X509Certificate;)V
    ...
    invoke-interface {p0}, Ll/a/c/t/a;->getTBSCertificateNative()Ll/a/a/f3/p0;
    ...
    invoke-static {p0}, Ll/a/a/f3/p0;->q(Ljava/lang/Object;)Ll/a/a/f3/p0;
    :try_end_1
...
.method public engineGetRevocationChecker()Ljava/security/cert/PKIXCertPathChecker;
    ...
    iget-object v1, p0, Lorg/bouncycastle/jce/provider/PKIXCertPathValidatorSpi_8;->helper:Ll/a/c/w/c;

    invoke-direct {v0, v1}, Lorg/bouncycastle/jce/provider/ProvRevocationChecker;-><init>(Ll/a/c/w/c;)V
...
.method public engineValidate(Ljava/security/cert/CertPath;Ljava/security/cert/CertPathParameters;)Ljava/security/cert/CertPathValidatorResult;
    ...
    invoke-direct {v2, v3}, Ll/a/c/s$b;-><init>(Ljava/security/cert/PKIXParameters;)V

    instance-of v3, v0, Ll/a/h/d;

    if-eqz v3, :cond_0

    check-cast v0, Ll/a/h/d;

    invoke-virtual {v0}, Ll/a/h/d;->j()Z

    move-result v3

    invoke-virtual {v2, v3}, Ll/a/c/s$b;->s(Z)Ll/a/c/s$b;

    invoke-virtual {v0}, Ll/a/h/d;->i()I

    move-result v0

    invoke-virtual {v2, v0}, Ll/a/c/s$b;->t(I)Ll/a/c/s$b;
    ...
    :cond_1
    instance-of v2, v0, Ll/a/c/r;

    if-eqz v2, :cond_2

    check-cast v0, Ll/a/c/r;

    invoke-virtual {v0}, Ll/a/c/r;->b()Ll/a/c/s;
    ...
    :cond_2
    instance-of v2, v0, Ll/a/c/s;

    if-eqz v2, :cond_1b

    check-cast v0, Ll/a/c/s;

    :goto_0
    invoke-virtual {v0}, Ll/a/c/s;->w()Ljava/util/Set;
    ...
    invoke-static {v0, v2}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->getValidityDate(Ll/a/c/s;Ljava/util/Date;)Ljava/util/Date;

    move-result-object v15

    invoke-virtual {v0}, Ll/a/c/s;->r()Ljava/util/Set;
    ...
    invoke-virtual {v0}, Ll/a/c/s;->u()Ljava/lang/String;
    ...
    invoke-direct {v2, v0}, Ll/a/c/s$b;-><init>(Ll/a/c/s;)V

    invoke-virtual {v2, v9}, Ll/a/c/s$b;->r(Ljava/security/cert/TrustAnchor;)Ll/a/c/s$b;
    ...
    invoke-virtual {v0}, Ll/a/c/s;->n()Ljava/util/List;
    ...
    instance-of v4, v5, Ll/a/c/n;

    if-eqz v4, :cond_3

    check-cast v5, Ll/a/c/n;
    ...
    :cond_6
    invoke-virtual {v0}, Ll/a/c/s;->F()Z
    ...
    iget-object v2, v1, Lorg/bouncycastle/jce/provider/PKIXCertPathValidatorSpi_8;->helper:Ll/a/c/w/c;

    invoke-direct {v4, v2}, Lorg/bouncycastle/jce/provider/ProvRevocationChecker;-><init>(Ll/a/c/w/c;)V
    ...
    invoke-virtual {v0}, Ll/a/c/s;->C()Z
    ...
    :goto_3
    invoke-virtual {v0}, Ll/a/c/s;->A()Z
    ...
    :goto_4
    invoke-virtual {v0}, Ll/a/c/s;->D()Z
    ...
    :try_start_1
    invoke-static/range {v21 .. v21}, Lorg/bouncycastle/jce/provider/PrincipalUtils;->getSubjectPrincipal(Ljava/security/cert/X509Certificate;)Ll/a/a/e3/c;
    ...
    :cond_c
    invoke-static {v9}, Lorg/bouncycastle/jce/provider/PrincipalUtils;->getCA(Ljava/security/cert/TrustAnchor;)Ll/a/a/e3/c;
    ...
    :goto_5
    :try_start_2
    invoke-static/range {v23 .. v23}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->getAlgorithmIdentifier(Ljava/security/PublicKey;)Ll/a/a/f3/b;

    move-result-object v3
    :try_end_2
    .catch Ljava/security/cert/CertPathValidatorException; {:try_start_2 .. :try_end_2} :catch_2

    invoke-virtual {v3}, Ll/a/a/f3/b;->o()Ll/a/a/o;

    invoke-virtual {v3}, Ll/a/a/f3/b;->r()Ll/a/a/e;

    invoke-virtual {v0}, Ll/a/c/s;->v()Ll/a/c/q;
    ...
    invoke-virtual {v3, v10}, Ll/a/c/q;->match(Ljava/security/cert/Certificate;)Z
    ...
    invoke-direct {v0, v2, v14, v11, v7}, Ll/a/d/f/b;-><init>(Ljava/lang/String;Ljava/lang/Throwable;Ljava/security/cert/CertPath;I)V
    ...
    invoke-static/range {v2 .. v10}, Lorg/bouncycastle/jce/provider/RFC3280CertPathUtilities;->processCertA(Ljava/security/cert/CertPath;Ll/a/c/s;Ljava/util/Date;Ll/a/c/n;ILjava/security/PublicKey;ZLl/a/a/e3/c;Ljava/security/cert/X509Certificate;)V
    ...
    invoke-static {v13}, Lorg/bouncycastle/jce/provider/PrincipalUtils;->getSubjectPrincipal(Ljava/security/cert/X509Certificate;)Ll/a/a/e3/c;
    ...
    iget-object v14, v1, Lorg/bouncycastle/jce/provider/PKIXCertPathValidatorSpi_8;->helper:Ll/a/c/w/c;

    invoke-static {v8, v9, v14}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->getNextWorkingKey(Ljava/util/List;ILl/a/c/w/c;)Ljava/security/PublicKey;

    move-result-object v8
    :try_end_4
    .catch Ljava/security/cert/CertPathValidatorException; {:try_start_4 .. :try_end_4} :catch_0

    invoke-static {v8}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->getAlgorithmIdentifier(Ljava/security/PublicKey;)Ll/a/a/f3/b;

    move-result-object v14

    invoke-virtual {v14}, Ll/a/a/f3/b;->o()Ll/a/a/o;

    invoke-virtual {v14}, Ll/a/a/f3/b;->r()Ll/a/a/e;
    ...
    sget-object v2, Ll/a/a/f3/u;->f4:Ll/a/a/o;
    ...
    invoke-static/range {v2 .. v8}, Lorg/bouncycastle/jce/provider/RFC3280CertPathUtilities;->wrapupCertG(Ljava/security/cert/CertPath;Ll/a/c/s;Ljava/util/Set;I[Ljava/util/List;Lorg/bouncycastle/jce/provider/PKIXPolicyNode;Ljava/util/Set;)Lorg/bouncycastle/jce/provider/PKIXPolicyNode;
    ...
    invoke-direct {v0, v4, v2, v11, v3}, Ll/a/d/f/b;-><init>(Ljava/lang/String;Ljava/lang/Throwable;Ljava/security/cert/CertPath;I)V
    ...
    new-instance v2, Ll/a/d/f/b;

    const-string v4, "Subject of trust anchor could not be (re)encoded."

    invoke-direct {v2, v4, v0, v11, v3}, Ll/a/d/f/b;-><init>(Ljava/lang/String;Ljava/lang/Throwable;Ljava/security/cert/CertPath;I)V
