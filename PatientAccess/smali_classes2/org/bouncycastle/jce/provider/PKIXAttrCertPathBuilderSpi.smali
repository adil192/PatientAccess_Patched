...
.method private build(Ll/a/h/h;Ljava/security/cert/X509Certificate;Ll/a/c/r;Ljava/util/List;)Ljava/security/cert/CertPathBuilderResult;
    .locals 6
    ...
    :cond_0
    invoke-virtual {p3}, Ll/a/c/r;->c()Ljava/util/Set;
    ...
    :cond_1
    invoke-virtual {p3}, Ll/a/c/r;->d()I
    ...
    :try_start_1
    invoke-virtual {p3}, Ll/a/c/r;->b()Ll/a/c/s;
    ...
    invoke-virtual {v3}, Ll/a/c/s;->u()Ljava/lang/String;
    ...
    invoke-virtual {v3}, Ll/a/c/s;->q()Ljava/util/List;
    ...
    :cond_4
    invoke-direct {p0, p1, v1, p3, p4}, Lorg/bouncycastle/jce/provider/PKIXAttrCertPathBuilderSpi;->build(Ll/a/h/h;Ljava/security/cert/X509Certificate;Ll/a/c/r;Ljava/util/List;)Ljava/security/cert/CertPathBuilderResult;
...
.method protected static findCertificates(Ll/a/h/g;Ljava/util/List;)Ljava/util/Collection;
    .locals 3
    ...
    instance-of v2, v1, Ll/a/g/n;

    if-eqz v2, :cond_0

    check-cast v1, Ll/a/g/n;

    :try_start_0
    invoke-interface {v1, p0}, Ll/a/g/n;->getMatches(Ll/a/g/m;)Ljava/util/Collection;
...
.method public engineBuild(Ljava/security/cert/CertPathParameters;)Ljava/security/cert/CertPathBuilderResult;
    ...
    instance-of v1, p1, Ll/a/h/c;

    if-nez v1, :cond_1

    instance-of v1, p1, Ll/a/c/r;
    ...
    new-instance v0, Ll/a/c/r$b;

    move-object v2, p1

    check-cast v2, Ljava/security/cert/PKIXBuilderParameters;

    invoke-direct {v0, v2}, Ll/a/c/r$b;-><init>(Ljava/security/cert/PKIXBuilderParameters;)V
    ...
    invoke-virtual {v0, v1}, Ll/a/c/r$b;->d(Ljava/util/Set;)Ll/a/c/r$b;

    invoke-virtual {p1}, Ll/a/h/c;->n()I

    move-result v1

    invoke-virtual {v0, v1}, Ll/a/c/r$b;->f(I)Ll/a/c/r$b;

    invoke-virtual {p1}, Ll/a/h/d;->g()Ljava/util/List;

    move-result-object v1

    :cond_2
    invoke-virtual {v0}, Ll/a/c/r$b;->e()Ll/a/c/r;
    ...
    invoke-virtual {p1}, Ll/a/c/r;->b()Ll/a/c/s;

    move-result-object v2

    invoke-virtual {v2}, Ll/a/c/s;->v()Ll/a/c/q;

    move-result-object v3

    instance-of v4, v3, Ll/a/h/g;

    if-eqz v4, :cond_e

    :try_start_0
    check-cast v3, Ll/a/h/g;

    invoke-static {v3, v1}, Lorg/bouncycastle/jce/provider/PKIXAttrCertPathBuilderSpi;->findCertificates(Ll/a/h/g;Ljava/util/List;)Ljava/util/Collection;
    ...
    check-cast v4, Ll/a/h/h;

    new-instance v5, Ll/a/h/k;

    invoke-direct {v5}, Ll/a/h/k;-><init>()V

    invoke-interface {v4}, Ll/a/h/h;->c()Ll/a/h/b;

    move-result-object v6

    invoke-virtual {v6}, Ll/a/h/b;->c()[Ljava/security/Principal;
    ...
    :cond_5
    new-instance v9, Ll/a/c/q$b;

    invoke-direct {v9, v5}, Ll/a/c/q$b;-><init>(Ljava/security/cert/CertSelector;)V

    invoke-virtual {v9}, Ll/a/c/q$b;->a()Ll/a/c/q;

    move-result-object v9

    invoke-virtual {v2}, Ll/a/c/s;->p()Ljava/util/List;

    move-result-object v10

    invoke-static {v7, v9, v10}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->findCertificates(Ljava/util/LinkedHashSet;Ll/a/c/q;Ljava/util/List;)V
    ...
    invoke-direct {v0, v1, p1}, Ll/a/d/f/a;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-direct {p0, v4, v3, p1, v0}, Lorg/bouncycastle/jce/provider/PKIXAttrCertPathBuilderSpi;->build(Ll/a/h/h;Ljava/security/cert/X509Certificate;Ll/a/c/r;Ljava/util/List;)Ljava/security/cert/CertPathBuilderResult;
    ...
    invoke-direct {p1, v1, v0}, Ll/a/d/f/a;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
