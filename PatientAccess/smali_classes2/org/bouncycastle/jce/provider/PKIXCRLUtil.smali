...
.method static findCRLs(Ll/a/c/m;Ljava/util/Date;Ljava/util/List;Ljava/util/List;)Ljava/util/Set;
    .locals 3
    ...
    :try_start_0
    invoke-static {v0, p0, p3}, Lorg/bouncycastle/jce/provider/PKIXCRLUtil;->findCRLs(Ljava/util/HashSet;Ll/a/c/m;Ljava/util/List;)V

    invoke-static {v0, p0, p2}, Lorg/bouncycastle/jce/provider/PKIXCRLUtil;->findCRLs(Ljava/util/HashSet;Ll/a/c/m;Ljava/util/List;)V
    :try_end_0
    ...
    invoke-virtual {p0}, Ll/a/c/m;->d()Ljava/security/cert/X509Certificate;
...
.method private static findCRLs(Ljava/util/HashSet;Ll/a/c/m;Ljava/util/List;)V
    .locals 6
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/bouncycastle/jce/provider/AnnotatedException;
    ...
    check-cast v2, Ll/a/g/n;

    :try_start_0
    invoke-interface {v2, p1}, Ll/a/g/n;->getMatches(Ll/a/g/m;)Ljava/util/Collection;
    ...
    :try_start_1
    invoke-static {p1, v2}, Ll/a/c/m;->c(Ll/a/c/m;Ljava/security/cert/CertStore;)Ljava/util/Collection;
