...
.method static constructor <clinit>()V
    ...
    sget-object v0, Ll/a/a/f3/u;->o4:Ll/a/a/o;
...
.method protected static additionalChecks(Ll/a/h/h;Ljava/util/Set;Ljava/util/Set;)V
    .locals 3
    ...
    invoke-interface {p0, v0}, Ll/a/h/h;->b(Ljava/lang/String;)[Ll/a/h/f;
    ...
    invoke-interface {p0, p2}, Ll/a/h/h;->b(Ljava/lang/String;)[Ll/a/h/f;
...
.method private static checkCRL(Ll/a/a/f3/s;Ll/a/h/h;Ll/a/c/s;Ljava/util/Date;Ljava/util/Date;Ljava/security/cert/X509Certificate;Lorg/bouncycastle/jce/provider/CertStatus;Lorg/bouncycastle/jce/provider/ReasonsMask;Ljava/util/List;Ll/a/c/w/c;)V
    .locals 22
    .annotation system Ldalvik/annotation/Throws;
        value = {
    ...
    sget-object v0, Ll/a/a/f3/x0;->o4:Ll/a/a/o;
    ...
    invoke-direct/range {v2 .. v8}, Ll/a/c/o;-><init>(Ll/a/c/s;Ljava/util/Date;Ljava/security/cert/CertPath;ILjava/security/cert/X509Certificate;Ljava/security/PublicKey;)V

    invoke-static {v0, v1, v9, v10, v11}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->getCompleteCRLs(Ll/a/c/o;Ll/a/a/f3/s;Ljava/lang/Object;Ll/a/c/s;Ljava/util/Date;)Ljava/util/Set;
    ...
    :try_start_2
    invoke-static {v5, v15, v3, v4, v6}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->getDeltaCRLs(Ljava/util/Date;Ljava/security/cert/X509CRL;Ljava/util/List;Ljava/util/List;Ll/a/c/w/c;)Ljava/util/Set;
    ...
    :try_start_3
    invoke-interface/range {p1 .. p1}, Ll/a/h/h;->getNotAfter()Ljava/util/Date;
    ...
    :cond_4
    :goto_2
    invoke-static {v1, v9, v15}, Lorg/bouncycastle/jce/provider/RFC3280CertPathUtilities;->processCRLB1(Ll/a/a/f3/s;Ljava/lang/Object;Ljava/security/cert/X509CRL;)V

    invoke-static {v1, v9, v15}, Lorg/bouncycastle/jce/provider/RFC3280CertPathUtilities;->processCRLB2(Ll/a/a/f3/s;Ljava/lang/Object;Ljava/security/cert/X509CRL;)V

    invoke-static {v2, v15, v10}, Lorg/bouncycastle/jce/provider/RFC3280CertPathUtilities;->processCRLC(Ljava/security/cert/X509CRL;Ljava/security/cert/X509CRL;Ll/a/c/s;)V

    invoke-static {v11, v2, v9, v12, v10}, Lorg/bouncycastle/jce/provider/RFC3280CertPathUtilities;->processCRLI(Ljava/util/Date;Ljava/security/cert/X509CRL;Ljava/lang/Object;Lorg/bouncycastle/jce/provider/CertStatus;Ll/a/c/s;)V
...
.method protected static checkCRLs(Ll/a/h/h;Ll/a/c/s;Ljava/util/Date;Ljava/util/Date;Ljava/security/cert/X509Certificate;Ljava/util/List;Ll/a/c/w/c;)V
    .locals 20
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/security/cert/CertPathValidatorException;
    ...
    invoke-virtual/range {p1 .. p1}, Ll/a/c/s;->F()Z
    ...
    invoke-static {v11, v0}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->getExtensionValue(Ljava/security/cert/X509Extension;Ljava/lang/String;)Ll/a/a/t;
    ...
    invoke-static {v0, v2, v12, v13}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->getAdditionalStoresFromCRLDistributionPoint(Ll/a/a/f3/k;Ljava/util/Map;Ljava/util/Date;Ll/a/c/w/c;)Ljava/util/List;
    ...
    new-instance v2, Ll/a/c/s$b;

    move-object/from16 v3, p1

    invoke-direct {v2, v3}, Ll/a/c/s$b;-><init>(Ll/a/c/s;)V
    ...
    check-cast v4, Ll/a/c/l;

    invoke-virtual {v2, v4}, Ll/a/c/s$b;->m(Ll/a/c/l;)Ll/a/c/s$b;

    goto :goto_0

    :cond_0
    invoke-virtual {v2}, Ll/a/c/s$b;->o()Ll/a/c/s;
    ...
    invoke-virtual {v14}, Ll/a/c/s;->clone()Ljava/lang/Object;
    ...
    :try_start_4
    invoke-static/range {v1 .. v10}, Lorg/bouncycastle/jce/provider/RFC3281CertPathUtilities;->checkCRL(Ll/a/a/f3/s;Ll/a/h/h;Ll/a/c/s;Ljava/util/Date;Ljava/util/Date;Ljava/security/cert/X509Certificate;Lorg/bouncycastle/jce/provider/CertStatus;Lorg/bouncycastle/jce/provider/ReasonsMask;Ljava/util/List;Ll/a/c/w/c;)V
    :try_end_4
    ...
    invoke-direct {v0, v2, v1}, Ll/a/d/f/b;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    :try_start_5
    invoke-static/range {p0 .. p0}, Lorg/bouncycastle/jce/provider/PrincipalUtils;->getEncodedIssuerPrincipal(Ljava/lang/Object;)Ll/a/a/e3/c;
    ...
    invoke-direct {v1, v2, v0}, Ll/a/d/f/b;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method protected static processAttrCert1(Ll/a/h/h;Ll/a/c/s;)Ljava/security/cert/CertPath;
    .locals 10
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/security/cert/CertPathValidatorException;
    ...
    invoke-interface {p0}, Ll/a/h/h;->a()Ll/a/h/a;

    move-result-object v2

    invoke-virtual {v2}, Ll/a/h/a;->e()[Ljava/security/Principal;
    ...
    invoke-virtual {v6}, Ll/a/h/a;->j()Ljava/math/BigInteger;
    ...
    invoke-virtual {v6}, Ll/a/h/a;->e()[Ljava/security/Principal;
    ...
    :cond_0
    new-instance v8, Ll/a/c/q$b;

    invoke-direct {v8, v2}, Ll/a/c/q$b;-><init>(Ljava/security/cert/CertSelector;)V

    invoke-virtual {v8}, Ll/a/c/q$b;->a()Ll/a/c/q;

    move-result-object v8

    invoke-virtual {p1}, Ll/a/c/s;->p()Ljava/util/List;

    move-result-object v9

    invoke-static {v1, v8, v9}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->findCertificates(Ljava/util/LinkedHashSet;Ll/a/c/q;Ljava/util/List;)V
    :try_end_0
    ...
    invoke-direct {p1, v3, p0}, Ll/a/d/f/b;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-direct {p1, v4, p0}, Ll/a/d/f/b;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    new-instance v2, Ll/a/h/k;

    invoke-direct {v2}, Ll/a/h/k;-><init>()V

    invoke-interface {p0}, Ll/a/h/h;->a()Ll/a/h/a;

    move-result-object p0

    invoke-virtual {p0}, Ll/a/h/a;->d()[Ljava/security/Principal;
    ...
    :cond_4
    new-instance v6, Ll/a/c/q$b;

    invoke-direct {v6, v2}, Ll/a/c/q$b;-><init>(Ljava/security/cert/CertSelector;)V

    invoke-virtual {v6}, Ll/a/c/q$b;->a()Ll/a/c/q;
    ...
    invoke-static {v1, v6, v7}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->findCertificates(Ljava/util/LinkedHashSet;Ll/a/c/q;Ljava/util/List;)V
    :try_end_1
    ...
    :cond_7
    :goto_3
    new-instance p0, Ll/a/c/s$b;

    invoke-direct {p0, p1}, Ll/a/c/s$b;-><init>(Ll/a/c/s;)V
    ...
    new-instance v3, Ll/a/h/k;

    invoke-direct {v3}, Ll/a/h/k;-><init>()V
    ...
    new-instance v4, Ll/a/c/q$b;

    invoke-direct {v4, v3}, Ll/a/c/q$b;-><init>(Ljava/security/cert/CertSelector;)V

    invoke-virtual {v4}, Ll/a/c/q$b;->a()Ll/a/c/q;

    move-result-object v3

    invoke-virtual {p0, v3}, Ll/a/c/s$b;->q(Ll/a/c/q;)Ll/a/c/s$b;
    ...
    invoke-virtual {p0}, Ll/a/c/s$b;->o()Ll/a/c/s;
    ...
    invoke-direct {v3, v4, v1}, Ll/a/d/f/b;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-direct {p1, v0, p0}, Ll/a/d/f/b;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method protected static processAttrCert2(Ljava/security/cert/CertPath;Ll/a/c/s;)Ljava/security/cert/CertPathValidatorResult;
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/security/cert/CertPathValidatorException;
...
.method protected static processAttrCert3(Ljava/security/cert/X509Certificate;Ll/a/c/s;)V
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/security/cert/CertPathValidatorException;
...
.method protected static processAttrCert5(Ll/a/h/h;Ljava/util/Date;)V
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/security/cert/CertPathValidatorException;
    ...
    :try_start_0
    invoke-interface {p0, p1}, Ll/a/h/h;->checkValidity(Ljava/util/Date;)V
    :try_end_0
...
.method protected static processAttrCert7(Ll/a/h/h;Ljava/security/cert/CertPath;Ljava/security/cert/CertPath;Ll/a/c/s;Ljava/util/Set;)V
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/security/cert/CertPathValidatorException;
    ...
    :try_start_0
    invoke-static {p0, v1}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->getExtensionValue(Ljava/security/cert/X509Extension;Ljava/lang/String;)Ll/a/a/t;

    move-result-object v2

    invoke-static {v2}, Ll/a/a/f3/s0;->o(Ljava/lang/Object;)Ll/a/a/f3/s0;
    :try_end_0
    .catch Lorg/bouncycastle/jce/provider/AnnotatedException; {:try_start_0 .. :try_end_0} :catch_1
    ...
    invoke-direct {p1, p3, p0}, Ll/a/d/f/b;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    check-cast p4, Ll/a/h/e;

    invoke-virtual {p4, p0, p1, p2, v0}, Ll/a/h/e;->b(Ll/a/h/h;Ljava/security/cert/CertPath;Ljava/security/cert/CertPath;Ljava/util/Collection;)V
