...
.method static checkCRLsNotEmpty(Ll/a/c/o;Ljava/util/Set;Ljava/lang/Object;)V
    .locals 4
    ...
    invoke-interface {p2}, Ll/a/h/h;->c()Ll/a/h/b;

    move-result-object p2

    invoke-virtual {p2}, Ll/a/h/b;->c()[Ljava/security/Principal;
    ...
    invoke-virtual {p0}, Ll/a/c/o;->a()Ljava/security/cert/CertPath;

    move-result-object v1

    invoke-virtual {p0}, Ll/a/c/o;->b()I
    ...
    sget-object v2, Ll/a/a/e3/f/e;->T:Ll/a/a/e3/e;

    invoke-static {p2}, Lorg/bouncycastle/jce/provider/PrincipalUtils;->getIssuerPrincipal(Ljava/security/cert/X509Certificate;)Ll/a/a/e3/c;

    move-result-object p2

    invoke-interface {v2, p2}, Ll/a/a/e3/e;->f(Ll/a/a/e3/c;)Ljava/lang/String;
...
.method protected static findCertificates(Ljava/util/LinkedHashSet;Ll/a/c/q;Ljava/util/List;)V
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
    ...
    instance-of v1, v0, Ll/a/g/n;

    if-eqz v1, :cond_0

    check-cast v0, Ll/a/g/n;

    :try_start_0
    invoke-interface {v0, p1}, Ll/a/g/n;->getMatches(Ll/a/g/m;)Ljava/util/Collection;

    move-result-object v0

    invoke-virtual {p0, v0}, Ljava/util/LinkedHashSet;->addAll(Ljava/util/Collection;)Z
    :try_end_0
    .catch Ll/a/g/o; {:try_start_0 .. :try_end_0} :catch_0
    ...
    :try_start_1
    invoke-static {p1, v0}, Ll/a/c/q;->d(Ll/a/c/q;Ljava/security/cert/CertStore;)Ljava/util/Collection;
...
.method static findIssuerCerts(Ljava/security/cert/X509Certificate;Ljava/util/List;Ljava/util/List;)Ljava/util/Collection;
    ...
    invoke-static {p0}, Ll/a/a/f3/i;->o(Ljava/lang/Object;)Ll/a/a/f3/i;

    move-result-object p0

    invoke-virtual {p0}, Ll/a/a/f3/i;->p()[B
    ...
    invoke-direct {p0, v0}, Ll/a/c/q$b;-><init>(Ljava/security/cert/CertSelector;)V
    ...
    :try_start_2
    invoke-static {v0, p0, p1}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->findCertificates(Ljava/util/LinkedHashSet;Ll/a/c/q;Ljava/util/List;)V

    invoke-static {v0, p0, p2}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->findCertificates(Ljava/util/LinkedHashSet;Ll/a/c/q;Ljava/util/List;)V
    :try_end_2
...
.method static findTargets(Ll/a/c/r;)Ljava/util/Collection;
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
    ...
    invoke-virtual {p0}, Ll/a/c/r;->b()Ll/a/c/s;

    move-result-object p0

    invoke-virtual {p0}, Ll/a/c/s;->v()Ll/a/c/q;
    ...
    :try_start_0
    invoke-virtual {p0}, Ll/a/c/s;->q()Ljava/util/List;

    move-result-object v2

    invoke-static {v1, v0, v2}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->findCertificates(Ljava/util/LinkedHashSet;Ll/a/c/q;Ljava/util/List;)V

    invoke-virtual {p0}, Ll/a/c/s;->p()Ljava/util/List;

    move-result-object p0

    invoke-static {v1, v0, p0}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->findCertificates(Ljava/util/LinkedHashSet;Ll/a/c/q;Ljava/util/List;)V
    :try_end_0
    ...
    :cond_0
    invoke-virtual {v0}, Ll/a/c/q;->c()Ljava/security/cert/Certificate;
    ...
    new-instance v0, Ll/a/d/f/a;

    const-string v1, "Error finding target certificate."

    invoke-direct {v0, v1, p0}, Ll/a/d/f/a;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method protected static findTrustAnchor(Ljava/security/cert/X509Certificate;Ljava/util/Set;Ljava/lang/String;)Ljava/security/cert/TrustAnchor;
    ...
    invoke-static {v7}, Ll/a/a/e3/c;->o(Ljava/lang/Object;)Ll/a/a/e3/c;

    move-result-object v7

    invoke-virtual {v5, v7}, Ll/a/a/e3/c;->equals(Ljava/lang/Object;)Z
...
.method static getAdditionalStoresFromCRLDistributionPoint(Ll/a/a/f3/k;Ljava/util/Map;Ljava/util/Date;Ll/a/c/w/c;)Ljava/util/List;
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {v3}, Ll/a/a/f3/s;->q()Ll/a/a/f3/t;

    move-result-object v3

    if-eqz v3, :cond_2

    invoke-virtual {v3}, Ll/a/a/f3/t;->s()I

    move-result v4

    if-nez v4, :cond_2

    invoke-virtual {v3}, Ll/a/a/f3/t;->r()Ll/a/a/e;
    ...
    invoke-interface {p3, p1}, Ll/a/c/w/c;->e(Ljava/lang/String;)Ljava/security/cert/CertificateFactory;
    ...
    invoke-virtual {v2}, Ll/a/a/f3/s;->q()Ll/a/a/f3/t;

    move-result-object v2

    if-eqz v2, :cond_5

    invoke-virtual {v2}, Ll/a/a/f3/t;->s()I

    move-result v3

    if-nez v3, :cond_5

    invoke-virtual {v2}, Ll/a/a/f3/t;->r()Ll/a/a/e;

    move-result-object v2

    invoke-static {v2}, Ll/a/a/f3/x;->p(Ljava/lang/Object;)Ll/a/a/f3/x;

    move-result-object v2

    invoke-virtual {v2}, Ll/a/a/f3/x;->r()[Ll/a/a/f3/w;
    ...
    invoke-virtual {v4}, Ll/a/a/f3/w;->s()I
    ...
    invoke-virtual {v4}, Ll/a/a/f3/w;->r()Ll/a/a/e;

    move-result-object v4

    check-cast v4, Ll/a/a/z;

    invoke-interface {v4}, Ll/a/a/z;->i()Ljava/lang/String;

    move-result-object v4

    invoke-direct {v5, v4}, Ljava/net/URI;-><init>(Ljava/lang/String;)V

    invoke-static {p1, p2, v5}, Lorg/bouncycastle/jce/provider/CrlCache;->getCrl(Ljava/security/cert/CertificateFactory;Ljava/util/Date;Ljava/net/URI;)Ll/a/c/l;
...
.method protected static getAlgorithmIdentifier(Ljava/security/PublicKey;)Ll/a/a/f3/b;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
    ...
    invoke-direct {v0, v1, p0}, Ll/a/d/f/b;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V

    throw v0
.end method

.method protected static getCRLIssuersFromDistributionPoint(Ll/a/a/f3/s;Ljava/util/Collection;Ljava/security/cert/X509CRLSelector;)V
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/bouncycastle/jce/provider/AnnotatedException;
...
.method protected static getCertStatus(Ljava/util/Date;Ljava/security/cert/X509CRL;Ljava/lang/Object;Lorg/bouncycastle/jce/provider/CertStatus;)V
    ...
    :cond_1
    invoke-static {v1}, Lorg/bouncycastle/jce/provider/PrincipalUtils;->getX500Name(Ljavax/security/auth/x500/X500Principal;)Ll/a/a/e3/c;

    move-result-object p1

    :goto_0
    invoke-static {p2}, Lorg/bouncycastle/jce/provider/PrincipalUtils;->getEncodedIssuerPrincipal(Ljava/lang/Object;)Ll/a/a/e3/c;

    move-result-object p2

    invoke-virtual {p2, p1}, Ll/a/a/e3/c;->equals(Ljava/lang/Object;)Z
    ...
    invoke-virtual {v0, v1}, Ll/a/a/e3/c;->equals(Ljava/lang/Object;)Z
    ...
    :try_start_1
    sget-object p1, Ll/a/a/f3/u;->T3:Ll/a/a/o;

    invoke-virtual {p1}, Ll/a/a/o;->E()Ljava/lang/String;

    move-result-object p1

    invoke-static {v0, p1}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->getExtensionValue(Ljava/security/cert/X509Extension;Ljava/lang/String;)Ll/a/a/t;

    move-result-object p1

    invoke-static {p1}, Ll/a/a/g;->A(Ljava/lang/Object;)Ll/a/a/g;
    ...
    :cond_7
    invoke-virtual {p1}, Ll/a/a/g;->E()I
...
.method protected static getCompleteCRLs(Ll/a/c/o;Ll/a/a/f3/s;Ljava/lang/Object;Ll/a/c/s;Ljava/util/Date;)Ljava/util/Set;
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/bouncycastle/jce/provider/AnnotatedException;,
    ...
    invoke-static {p1, v1, v0}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->getCRLIssuersFromDistributionPoint(Ll/a/a/f3/s;Ljava/util/Collection;Ljava/security/cert/X509CRLSelector;)V
    :try_end_0
    .catch Lorg/bouncycastle/jce/provider/AnnotatedException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    :cond_0
    new-instance p1, Ll/a/c/m$b;

    invoke-direct {p1, v0}, Ll/a/c/m$b;-><init>(Ljava/security/cert/CRLSelector;)V

    const/4 v0, 0x1

    invoke-virtual {p1, v0}, Ll/a/c/m$b;->h(Z)Ll/a/c/m$b;

    move-result-object p1

    invoke-virtual {p1}, Ll/a/c/m$b;->g()Ll/a/c/m;

    move-result-object p1

    invoke-virtual {p3}, Ll/a/c/s;->p()Ljava/util/List;

    move-result-object v0

    invoke-virtual {p3}, Ll/a/c/s;->m()Ljava/util/List;

    move-result-object p3

    invoke-static {p1, p4, v0, p3}, Lorg/bouncycastle/jce/provider/PKIXCRLUtil;->findCRLs(Ll/a/c/m;Ljava/util/Date;Ljava/util/List;Ljava/util/List;)Ljava/util/Set;

    move-result-object p1

    invoke-static {p0, p1, p2}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->checkCRLsNotEmpty(Ll/a/c/o;Ljava/util/Set;Ljava/lang/Object;)V
...
.method protected static getDeltaCRLs(Ljava/util/Date;Ljava/security/cert/X509CRL;Ljava/util/List;Ljava/util/List;Ll/a/c/w/c;)Ljava/util/Set;
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {p1, v1}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->getExtensionValue(Ljava/security/cert/X509Extension;Ljava/lang/String;)Ll/a/a/t;
    ...
    new-instance v2, Ll/a/c/m$b;

    invoke-direct {v2, v0}, Ll/a/c/m$b;-><init>(Ljava/security/cert/CRLSelector;)V

    invoke-virtual {v2, p1}, Ll/a/c/m$b;->i([B)V

    const/4 v0, 0x1

    invoke-virtual {v2, v0}, Ll/a/c/m$b;->j(Z)V

    invoke-virtual {v2, v1}, Ll/a/c/m$b;->k(Ljava/math/BigInteger;)V

    invoke-virtual {v2}, Ll/a/c/m$b;->g()Ll/a/c/m;

    move-result-object v0

    invoke-static {v0, p0, p2, p3}, Lorg/bouncycastle/jce/provider/PKIXCRLUtil;->findCRLs(Ll/a/c/m;Ljava/util/Date;Ljava/util/List;Ljava/util/List;)Ljava/util/Set;
    ...
    invoke-static {p3}, Ll/a/g/l;->c(Ljava/lang/String;)Z
    ...
    invoke-static {p1}, Ll/a/a/f3/k;->p(Ljava/lang/Object;)Ll/a/a/f3/k;

    move-result-object p1

    invoke-virtual {p1}, Ll/a/a/f3/k;->o()[Ll/a/a/f3/s;
    ...
    invoke-static {p3, p0, v5}, Lorg/bouncycastle/jce/provider/CrlCache;->getCrl(Ljava/security/cert/CertificateFactory;Ljava/util/Date;Ljava/net/URI;)Ll/a/c/l;
    ...
    invoke-static {v0, p0, v5, v4}, Lorg/bouncycastle/jce/provider/PKIXCRLUtil;->findCRLs(Ll/a/c/m;Ljava/util/Date;Ljava/util/List;Ljava/util/List;)Ljava/util/Set;
...
.method protected static getExtensionValue(Ljava/security/cert/X509Extension;Ljava/lang/String;)Ll/a/a/t;
    .locals 0
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/bouncycastle/jce/provider/AnnotatedException;
    ...
    :cond_0
    invoke-static {p1, p0}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->getObject(Ljava/lang/String;[B)Ll/a/a/t;
...
.method protected static getNextWorkingKey(Ljava/util/List;ILl/a/c/w/c;)Ljava/security/PublicKey;
    .locals 4
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/security/cert/CertPathValidatorException;
    ...
    invoke-interface {p2, p0}, Ll/a/c/w/c;->h(Ljava/lang/String;)Ljava/security/KeyFactory;
...
.method private static getObject(Ljava/lang/String;[B)Ll/a/a/t;
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/bouncycastle/jce/provider/AnnotatedException;
...
.method protected static final getQualifierSet(Ll/a/a/u;)Ljava/util/Set;
    .locals 5
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/security/cert/CertPathValidatorException;
    ...
    invoke-static {v1}, Ll/a/a/r;->a(Ljava/io/OutputStream;)Ll/a/a/r;
    ...
    check-cast v3, Ll/a/a/e;

    invoke-virtual {v2, v3}, Ll/a/a/r;->s(Ll/a/a/e;)V
...
.method protected static getValidCertDateFromValidityModel(Ljava/util/Date;ILjava/security/cert/CertPath;I)Ljava/util/Date;
    ...
    sget-object p3, Ll/a/a/p2/a;->e:Ll/a/a/o;

    invoke-virtual {p3}, Ll/a/a/o;->E()Ljava/lang/String;
    ...
    invoke-static {p1}, Ll/a/a/j;->E(Ljava/lang/Object;)Ll/a/a/j;
...
.method protected static getValidityDate(Ll/a/c/s;Ljava/util/Date;)Ljava/util/Date;
    .locals 0

    invoke-virtual {p0}, Ll/a/c/s;->x()Ljava/util/Date;
...
.method protected static prepareNextCertB1(I[Ljava/util/List;Ljava/lang/String;Ljava/util/Map;Ljava/security/cert/X509Certificate;)V
    ...
    invoke-static {p4, v3}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->getExtensionValue(Ljava/security/cert/X509Extension;Ljava/lang/String;)Ll/a/a/t;
    ...
    invoke-virtual {v3}, Ll/a/a/u;->C()Ljava/util/Enumeration;
    ...
    invoke-static {v5}, Ll/a/a/f3/j0;->o(Ljava/lang/Object;)Ll/a/a/f3/j0;

    move-result-object v5
    :try_end_1
    .catch Ljava/lang/Exception; {:try_start_1 .. :try_end_1} :catch_1

    invoke-virtual {v5}, Ll/a/a/f3/j0;->p()Ll/a/a/o;
    ...
    :try_start_2
    invoke-virtual {v5}, Ll/a/a/f3/j0;->q()Ll/a/a/u;

    move-result-object v0

    invoke-static {v0}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->getQualifierSet(Ll/a/a/u;)Ljava/util/Set;
    ...
    invoke-direct {p1, p2, p0}, Ll/a/d/f/b;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method protected static processCertD1i(I[Ljava/util/List;Ll/a/a/o;Ljava/util/Set;)Z
    .locals 12
...
.method protected static processCertD1ii(I[Ljava/util/List;Ll/a/a/o;Ljava/util/Set;)V
    .locals 11
