...
.method private static getAsymmetricKeyInfoConverter(Ll/a/a/o;)Lorg/bouncycastle/jcajce/provider/util/AsymmetricKeyInfoConverter;
    .locals 1
...
.method public static getPrivateKey(Ll/a/a/y2/p;)Ljava/security/PrivateKey;
    .locals 1
    ...
    invoke-static {v0}, Lorg/bouncycastle/jce/provider/BouncyCastleProvider;->getAsymmetricKeyInfoConverter(Ll/a/a/o;)Lorg/bouncycastle/jcajce/provider/util/AsymmetricKeyInfoConverter;
    ...
    :cond_0
    invoke-interface {v0, p0}, Lorg/bouncycastle/jcajce/provider/util/AsymmetricKeyInfoConverter;->generatePrivate(Ll/a/a/y2/p;)Ljava/security/PrivateKey;
...
.method public static getPublicKey(Ll/a/a/f3/n0;)Ljava/security/PublicKey;
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    :cond_0
    invoke-interface {v0, p0}, Lorg/bouncycastle/jcajce/provider/util/AsymmetricKeyInfoConverter;->generatePublic(Ll/a/a/f3/n0;)Ljava/security/PublicKey;
...
.method private loadPQCKeys()V
    ...
    new-instance v1, Ll/a/f/c/a/g/c;

    invoke-direct {v1}, Ll/a/f/c/a/g/c;-><init>()V

    invoke-virtual {p0, v0, v1}, Lorg/bouncycastle/jce/provider/BouncyCastleProvider;->addKeyInfoConverter(Ll/a/a/o;Lorg/bouncycastle/jcajce/provider/util/AsymmetricKeyInfoConverter;)V

    sget-object v0, Ll/a/f/a/e;->v:Ll/a/a/o;

    new-instance v1, Ll/a/f/c/a/d/c;

    invoke-direct {v1}, Ll/a/f/c/a/d/c;-><init>()V

    invoke-virtual {p0, v0, v1}, Lorg/bouncycastle/jce/provider/BouncyCastleProvider;->addKeyInfoConverter(Ll/a/a/o;Lorg/bouncycastle/jcajce/provider/util/AsymmetricKeyInfoConverter;)V

    sget-object v0, Ll/a/f/a/e;->w:Ll/a/a/o;

    new-instance v1, Ll/a/f/c/a/i/f;

    invoke-direct {v1}, Ll/a/f/c/a/i/f;-><init>()V
    ...
    sget-object v0, Ll/a/f/a/e;->F:Ll/a/a/o;

    new-instance v1, Ll/a/f/c/a/i/g;

    invoke-direct {v1}, Ll/a/f/c/a/i/g;-><init>()V
    ...
    new-instance v1, Ll/a/f/c/a/c/f;

    invoke-direct {v1}, Ll/a/f/c/a/c/f;-><init>()V

    invoke-virtual {p0, v0, v1}, Lorg/bouncycastle/jce/provider/BouncyCastleProvider;->addKeyInfoConverter(Ll/a/a/o;Lorg/bouncycastle/jcajce/provider/util/AsymmetricKeyInfoConverter;)V

    sget-object v0, Ll/a/f/a/e;->n:Ll/a/a/o;

    new-instance v1, Ll/a/f/c/a/c/e;

    invoke-direct {v1}, Ll/a/f/c/a/c/e;-><init>()V

    invoke-virtual {p0, v0, v1}, Lorg/bouncycastle/jce/provider/BouncyCastleProvider;->addKeyInfoConverter(Ll/a/a/o;Lorg/bouncycastle/jcajce/provider/util/AsymmetricKeyInfoConverter;)V

    sget-object v0, Ll/a/f/a/e;->a:Ll/a/a/o;

    new-instance v1, Ll/a/f/c/a/f/c;

    invoke-direct {v1}, Ll/a/f/c/a/f/c;-><init>()V

    invoke-virtual {p0, v0, v1}, Lorg/bouncycastle/jce/provider/BouncyCastleProvider;->addKeyInfoConverter(Ll/a/a/o;Lorg/bouncycastle/jcajce/provider/util/AsymmetricKeyInfoConverter;)V

    sget-object v0, Ll/a/f/a/e;->X:Ll/a/a/o;

    new-instance v1, Ll/a/f/c/a/e/c;

    invoke-direct {v1}, Ll/a/f/c/a/e/c;-><init>()V

    invoke-virtual {p0, v0, v1}, Lorg/bouncycastle/jce/provider/BouncyCastleProvider;->addKeyInfoConverter(Ll/a/a/o;Lorg/bouncycastle/jcajce/provider/util/AsymmetricKeyInfoConverter;)V

    sget-object v0, Ll/a/f/a/e;->Y:Ll/a/a/o;
    ...
    sget-object v0, Ll/a/a/y2/n;->O0:Ll/a/a/o;

    new-instance v1, Ll/a/f/c/a/b/c;

    invoke-direct {v1}, Ll/a/f/c/a/b/c;-><init>()V
...
.method public addAlgorithm(Ljava/lang/String;Ll/a/a/o;Ljava/lang/String;)V
    .locals 2
...
.method public addKeyInfoConverter(Ll/a/a/o;Lorg/bouncycastle/jcajce/provider/util/AsymmetricKeyInfoConverter;)V
    .locals 1
...
.method public getKeyInfoConverter(Ll/a/a/o;)Lorg/bouncycastle/jcajce/provider/util/AsymmetricKeyInfoConverter;
    .locals 1
