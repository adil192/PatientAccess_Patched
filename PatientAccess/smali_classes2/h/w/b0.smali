...
.method public static d()Ljava/util/Map;
    ...
    .line 1
    sget-object v0, Lh/w/u;->c:Lh/w/u;
...
.method public static varargs e([Lh/n;)Ljava/util/HashMap;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<K:",
    ...
    invoke-static {v0, p0}, Lh/w/b0;->k(Ljava/util/Map;[Lh/n;)V

    return-object v0
.end method

.method public static varargs f([Lh/n;)Ljava/util/Map;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<K:",
    ...
    invoke-static {p0, v0}, Lh/w/b0;->o([Lh/n;Ljava/util/Map;)Ljava/util/Map;
...
.method public static final g(Ljava/util/Map;)Ljava/util/Map;
    ...
    .line 2
    :cond_0
    invoke-static {p0}, Lh/w/a0;->c(Ljava/util/Map;)Ljava/util/Map;
...
.method public static i(Ljava/util/Map;Lh/n;)Ljava/util/Map;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<K:",
...
.method public static final k(Ljava/util/Map;[Lh/n;)V
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<K:",
...
.method public static l(Ljava/lang/Iterable;)Ljava/util/Map;
    ...
    invoke-static {p0, v1}, Lh/w/b0;->m(Ljava/lang/Iterable;Ljava/util/Map;)Ljava/util/Map;
    ...
    invoke-static {p0}, Lh/w/y;->b(Lh/n;)Ljava/util/Map;
    ...
    invoke-static {p0, v0}, Lh/w/b0;->m(Ljava/lang/Iterable;Ljava/util/Map;)Ljava/util/Map;

    move-result-object p0

    invoke-static {p0}, Lh/w/b0;->g(Ljava/util/Map;)Ljava/util/Map;
...
.method public static final m(Ljava/lang/Iterable;Ljava/util/Map;)Ljava/util/Map;
    ...
    .line 1
    invoke-static {p1, p0}, Lh/w/b0;->j(Ljava/util/Map;Ljava/lang/Iterable;)V
...
.method public static n(Ljava/util/Map;)Ljava/util/Map;
    ...
    .line 2
    invoke-static {p0}, Lh/w/y;->p(Ljava/util/Map;)Ljava/util/Map;
...
.method public static final o([Lh/n;Ljava/util/Map;)Ljava/util/Map;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<K:",
    ...
    .line 1
    invoke-static {p1, p0}, Lh/w/b0;->k(Ljava/util/Map;[Lh/n;)V
