...
.field public static final S3:Lkotlinx/coroutines/q0;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lkotlinx/coroutines/q0;->S3:Lkotlinx/coroutines/q0;
    ...
    .line 2
    invoke-static {v0, v1, v2, v3}, Lkotlinx/coroutines/d1;->G0(Lkotlinx/coroutines/d1;ZILjava/lang/Object;)V
    ...
    sput-wide v0, Lkotlinx/coroutines/q0;->R3:J
...
.method private final declared-synchronized d1()V
    ...
    .line 3
    invoke-virtual {p0}, Lkotlinx/coroutines/e1;->X0()V
...
.method private final declared-synchronized g1()Z
    .locals 1
...
.method public V(JLjava/lang/Runnable;Lh/z/g;)Lkotlinx/coroutines/z0;
    ...
    .line 1
    invoke-virtual {p0, p1, p2, p3}, Lkotlinx/coroutines/e1;->a1(JLjava/lang/Runnable;)Lkotlinx/coroutines/z0;
...
.method public run()V
    ...
    .line 7
    :cond_1
    invoke-virtual {p0}, Lkotlinx/coroutines/e1;->V0()Z

    move-result v0

    if-nez v0, :cond_2

    invoke-virtual {p0}, Lkotlinx/coroutines/q0;->M0()Ljava/lang/Thread;
    ...
    invoke-interface {v7}, Lkotlinx/coroutines/r2;->a()J
    ...
    .line 11
    sget-wide v3, Lkotlinx/coroutines/q0;->R3:J
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    :cond_9
    :try_start_2
    invoke-static {v5, v6, v10, v11}, Lh/g0/d;->d(JJ)J
    ...
    invoke-interface {v7, p0, v5, v6}, Lkotlinx/coroutines/r2;->f(Ljava/lang/Object;J)V
