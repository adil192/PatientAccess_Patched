...
.method private connectSocket(IILokhttp3/Call;Lokhttp3/EventListener;)V
    ...
    invoke-static {p1}, Lk/l;->m(Ljava/net/Socket;)Lk/s;
    ...
    invoke-static {p1}, Lk/l;->i(Ljava/net/Socket;)Lk/r;
...
.method private connectTls(Lokhttp3/internal/connection/ConnectionSpecSelector;)V
    ...
    .line 21
    invoke-static {v1}, Lk/l;->m(Ljava/net/Socket;)Lk/s;
...
.method private createTunnel(IILokhttp3/Request;Lokhttp3/HttpUrl;)Lokhttp3/Request;
    ...
    invoke-interface {v1}, Lk/s;->timeout()Lk/t;
    ...
    invoke-virtual {v1, v4, v5, v2}, Lk/t;->timeout(JLjava/util/concurrent/TimeUnit;)Lk/t;

    .line 4
    iget-object v1, p0, Lokhttp3/internal/connection/RealConnection;->sink:Lk/d;

    invoke-interface {v1}, Lk/r;->timeout()Lk/t;
    ...
    .line 11
    :cond_0
    invoke-virtual {v0, v4, v5}, Lokhttp3/internal/http1/Http1Codec;->newFixedLengthSource(J)Lk/s;
    ...
    .line 12
    invoke-static {v0, v1, v2}, Lokhttp3/internal/Util;->skipAll(Lk/s;ILjava/util/concurrent/TimeUnit;)Z
    ...
    invoke-interface {p1}, Lk/e;->b()Lk/c;

    move-result-object p1

    invoke-virtual {p1}, Lk/c;->w()Z
...
.method public newCodec(Lokhttp3/OkHttpClient;Lokhttp3/Interceptor$Chain;Lokhttp3/internal/connection/StreamAllocation;)Lokhttp3/internal/http/HttpCodec;
    ...
    invoke-virtual {v0, v1, v2, v3}, Lk/t;->timeout(JLjava/util/concurrent/TimeUnit;)Lk/t;
