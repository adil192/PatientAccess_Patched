...
.method private readHeaderLine()Ljava/lang/String;
    ...
    invoke-interface {v0, v1, v2}, Lk/e;->F(J)Ljava/lang/String;
...
.method public createRequestBody(Lokhttp3/Request;J)Lk/r;
    .locals 2
    ...
    .line 2
    invoke-virtual {p0}, Lokhttp3/internal/http1/Http1Codec;->newChunkedSink()Lk/r;
    ...
    .line 3
    invoke-virtual {p0, p2, p3}, Lokhttp3/internal/http1/Http1Codec;->newFixedLengthSink(J)Lk/r;
...
.method detachTimeout(Lk/i;)V
    ...
    .line 1
    invoke-virtual {p1}, Lk/i;->a()Lk/t;

    move-result-object v0

    .line 2
    sget-object v1, Lk/t;->NONE:Lk/t;

    invoke-virtual {p1, v1}, Lk/i;->b(Lk/t;)Lk/i;
...
.method public newChunkedSink()Lk/r;
    .locals 3
...
.method public newChunkedSource(Lokhttp3/HttpUrl;)Lk/s;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
...
.method public newFixedLengthSink(J)Lk/r;
    .locals 2
...
.method public newFixedLengthSource(J)Lk/s;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
...
.method public newUnknownLengthSource()Lk/s;
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
...
.method public openResponseBody(Lokhttp3/Response;)Lokhttp3/ResponseBody;
    ...
    .line 4
    invoke-virtual {p0, v1, v2}, Lokhttp3/internal/http1/Http1Codec;->newFixedLengthSource(J)Lk/s;
    ...
    invoke-virtual {p0, p1}, Lokhttp3/internal/http1/Http1Codec;->newChunkedSource(Lokhttp3/HttpUrl;)Lk/s;
    ...
    .line 10
    invoke-virtual {p0, v4, v5}, Lokhttp3/internal/http1/Http1Codec;->newFixedLengthSource(J)Lk/s;
    ...
    invoke-virtual {p0}, Lokhttp3/internal/http1/Http1Codec;->newUnknownLengthSource()Lk/s;

    move-result-object v1

    invoke-static {v1}, Lk/l;->d(Lk/s;)Lk/e;
...
.method public writeRequest(Lokhttp3/Headers;Ljava/lang/String;)V
    ...
    invoke-interface {v0, p2}, Lk/d;->L(Ljava/lang/String;)Lk/d;

    move-result-object p2

    const-string v0, "\r\n"

    invoke-interface {p2, v0}, Lk/d;->L(Ljava/lang/String;)Lk/d;
    ...
    invoke-interface {v2, v3}, Lk/d;->L(Ljava/lang/String;)Lk/d;
    ...
    .line 7
    invoke-interface {v2, v0}, Lk/d;->L(Ljava/lang/String;)Lk/d;
