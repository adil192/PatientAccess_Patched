.class Lio/paperdb/DbStoragePlainFile;
.super Ljava/lang/Object;
.source "SourceFile"


# static fields
.field private static final BACKUP_EXTENSION:Ljava/lang/String; = ".bak"
...
.method private declared-synchronized assertInit()V
    .locals 3
...
.method private createKryoInstance(Z)Lcom/esotericsoftware/kryo/Kryo;
    ...
    new-instance v1, Ll/f/c/d;

    invoke-direct {v1}, Ll/f/c/d;-><init>()V

    invoke-direct {p1, v1}, Lcom/esotericsoftware/kryo/Kryo$DefaultInstantiatorStrategy;-><init>(Ll/f/c/b;)V

    invoke-virtual {v0, p1}, Lcom/esotericsoftware/kryo/Kryo;->setInstantiatorStrategy(Ll/f/c/b;)V
...
.method private writeTableFile(Ljava/lang/String;Lio/paperdb/PaperTable;Ljava/io/File;Ljava/io/File;)V
    ...
    invoke-virtual {v3, v2, p2}, Lcom/esotericsoftware/kryo/Kryo;->writeObject(Lcom/esotericsoftware/kryo/io/Output;Ljava/lang/Object;)V
    ...
    .line 6
    invoke-static {v1}, Lio/paperdb/DbStoragePlainFile;->sync(Ljava/io/FileOutputStream;)V
    ...
    .catch Lcom/esotericsoftware/kryo/KryoException; {:try_start_2 .. :try_end_2} :catch_2
    ...
    const-string v1, "Couldn\'t save table: "
...
.method destroy()V
    ...
    invoke-virtual {v0}, Lio/paperdb/KeyLocker;->acquireGlobal()V
    ...
    invoke-virtual {v0}, Lio/paperdb/KeyLocker;->releaseGlobal()V
    ...
    invoke-virtual {v1}, Lio/paperdb/KeyLocker;->releaseGlobal()V
...
.method getAllKeys()Ljava/util/List;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    .line 4
    new-instance v1, Lio/paperdb/DbStoragePlainFile$2;

    invoke-direct {v1, p0}, Lio/paperdb/DbStoragePlainFile$2;-><init>(Lio/paperdb/DbStoragePlainFile;)V
