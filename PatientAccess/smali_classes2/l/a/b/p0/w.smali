...
.method public constructor <init>(Ll/a/b/r;)V
    ...
    iput-object p1, p0, Ll/a/b/p0/w;->a:Ll/a/b/r;
...
.method private a()[B
    ...
    iget-object v0, p0, Ll/a/b/p0/w;->a:Ll/a/b/r;
    ...
    iget-object v2, p0, Ll/a/b/p0/w;->a:Ll/a/b/r;

    iget-object v3, p0, Ll/a/b/b0;->password:[B

    array-length v4, v3

    const/4 v5, 0x0

    invoke-interface {v2, v3, v5, v4}, Ll/a/b/r;->update([BII)V

    iget-object v2, p0, Ll/a/b/p0/w;->a:Ll/a/b/r;

    iget-object v3, p0, Ll/a/b/b0;->salt:[B
    ...
    invoke-interface {v2, v1, v5}, Ll/a/b/r;->doFinal([BI)I

    const/4 v2, 0x1

    :goto_0
    iget v3, p0, Ll/a/b/b0;->iterationCount:I

    if-ge v2, v3, :cond_0

    iget-object v3, p0, Ll/a/b/p0/w;->a:Ll/a/b/r;

    invoke-interface {v3, v1, v5, v0}, Ll/a/b/r;->update([BII)V

    iget-object v3, p0, Ll/a/b/p0/w;->a:Ll/a/b/r;

    invoke-interface {v3, v1, v5}, Ll/a/b/r;->doFinal([BI)I
...
.method public generateDerivedMacParameters(I)Ll/a/b/i;
    ...
    invoke-virtual {p0, p1}, Ll/a/b/p0/w;->generateDerivedParameters(I)Ll/a/b/i;
...
.method public generateDerivedParameters(I)Ll/a/b/i;
    ...
    invoke-direct {p0}, Ll/a/b/p0/w;->a()[B
...
.method public generateDerivedParameters(II)Ll/a/b/i;
    ...
    iget-object v1, p0, Ll/a/b/p0/w;->a:Ll/a/b/r;
